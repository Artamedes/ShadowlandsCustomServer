...
void AddSpellsScripts()
{
    ...
    AddSC_spell_shaman_restoration();
    AddSC_spell_shaman_covenant();
    AddSC_spell_shaman_legendary();
    AddSC_spell_shaman_elemental();
    AddSC_spell_shaman_enhancement();
