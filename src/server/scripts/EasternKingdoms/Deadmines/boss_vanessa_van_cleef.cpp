                    ...
                    switch (eventId)
                    {
                        ...
                        case EVENT_SUMMON_DEFIAS_REINFORCEMENT:
                        {
                            if (me->HealthAbovePct(50))
                            {
                                ...
                                me->CastSpell(defiasReinforcementPositions[_currentReinforcement], defiasReinforcementSpells[_currentReinforcement], true);
                        ...
                        case EVENT_SUMMON_ENTRANCE_FIRE:
                            for (uint8 i = 0; i < 6; i++)
                                DoSummon(NPC_GENERAL_PURPOSE_DUMMY_JMF, VanessaEntranceFirePos[i], 0s, TEMPSUMMON_MANUAL_DESPAWN);
                            break;
                        ...
                        case EVENT_SUMMON_DETONATION_FIRE:
                            ...
                            {
                                if (Creature* dummy = DoSummon(NPC_GLUBTOK_NIGHTMARE_FIRE_BUNNY, VanessaNightmareFirePos[i], 0s, TEMPSUMMON_MANUAL_DESPAWN))
                                {
