    ...
    public:
        ...
        struct boss_foe_reaper_5000AI : public BossAI
        {
            ...
            void Reset() override
            {
                ...
                else
                {
                    me->RemoveAurasDueToSpell(SPELL_OFF_LINE);
                    {
                        ...
                        me->RemoveUnitFlag(UNIT_FLAG_STUNNED | UNIT_FLAG_IMMUNE_TO_PC);
                    }
                }
            }
            ...
            void JustDied(Unit* /*killer*/) override
            {
                ...
                if (IsHeroic())
                    if (Creature* prototypeReaper = instance->GetCreature(DATA_PROTOTYPE_REAPER))
                        prototypeReaper->DespawnOrUnsummon(0ms);
            }
            ...
            void EnterEvadeMode(EvadeReason /*why*/) override
            {
                ...
                if (IsHeroic())
                    if (Creature* prototypeReaper = instance->GetCreature(DATA_PROTOTYPE_REAPER))
                        prototypeReaper->DespawnOrUnsummon(0ms, Seconds(30));
                _DespawnAtEvade();
            }
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_HARVEST_SWEEP:
                            ...
                            me->setAttackTimer(BASE_ATTACK, me->m_unitData->AttackRoundBaseTime[0]);
