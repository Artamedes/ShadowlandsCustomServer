        ...
        public:
            ...
            struct boss_AI : public BossAI
            {
                ...
                void JustEngagedWith(Unit* u) override
                {
                    ...
                    events.ScheduleEvent((uint32)Events::MagmaBarrageCast, 4000ms);
                    events.ScheduleEvent((uint32)Events::SpawnRuination, 6000ms);
                    events.ScheduleEvent((uint32)Events::SpawnCalamity, 25000ms);
                }
                ...
                void UpdateAI(const uint32 diff) override
                {
                    ...
                    switch ((Events)events.ExecuteEvent())
                    {
                        case Events::MagmaBarrageCast:
                        {
                            ...
                            events.ScheduleEvent((uint32)Events::MagmaBarrageCast, 10000ms);
                            break;
                        }
            ...
            struct boss_AI : public BossAI
            {
                ...
                void MovementInform(uint32 type_Id, uint32 id) override
                {
                    if (id == 1 && (type_Id == POINT_MOTION_TYPE || type_Id == EFFECT_MOTION_TYPE))
                    {
                        ...
                        events.ScheduleEvent((uint32)Events::CastFlames, 5000ms);
                    }
                }
                ...
                void NextEvent()
                {
                    switch (urand(0, 2))
                    {
                        case 0:
                            ...
                            break;
                        case 1:
                            events.ScheduleEvent(uint32(Events::CastImpact), 10000ms);
                            break;
                        case 2:
                            events.ScheduleEvent(uint32(Events::CastSmash), 5000ms);
                            break;
                        default:
                            break;
                    ...
                    switch ((Events)events.ExecuteEvent())
                    {
                        ...
                        case Events::CastImpact:
                        {
                            ...
                            if (Unit* target = me->SelectNearbyTarget(nullptr, VISIBLE_RANGE))
                                me->CastSpell(*target, (uint32)Spells::MoltenImpact, false);
    ...
    class npc_ruination : public CreatureScript
    {
        public:
            ...
            struct npc_ruinationAI : public ScriptedAI
            {
                ...
                {
                    events.Reset();
                    events.ScheduleEvent((uint32)Events::CastSpell, 6000ms);
                }
                ...
                void UpdateAI(const uint32 diff) override
                {
                    ...
                    if ((Events)events.ExecuteEvent() == Events::CastSpell)
                    {
                        ...
                        events.ScheduleEvent((uint32)Events::CastSpell, 5000ms);
                    }
            ...
            struct npc_shatter_earthAI : public ScriptedAI
            {
                ...
                void UpdateAI(const uint32 diff) override
                {
                    ...
                    if (m_DeathTimer <= 0)
                    {
                        ...
                        Unit::DealDamage(me, me, health, nullptr, NODAMAGE);
    ...
    class spell_rough_smash: public SpellScriptLoader
    {
        public:
            ...
            class spell_rough_smash_SpellScript : public SpellScript
            {
                ...
                void Register() override
                {
                    OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(spell_rough_smash_SpellScript::FilterTargets, EFFECT_0, TARGET_UNIT_CONE_CASTER_TO_DEST_ENEMY);
                    OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(spell_rough_smash_SpellScript::FilterTargets, EFFECT_1, TARGET_UNIT_CONE_CASTER_TO_DEST_ENEMY);
                    ...
                    if (Unit* caster = GetCaster())
                    {
                        ...
                        if (Unit* target = caster->SelectNearbyTarget(nullptr, VISIBLE_RANGE))
                        {
                            for (uint8 l_I = 0; l_I < 4; l_I++)
                                caster->CastSpell(*target, ShatterEarthSpikeSpells[l_I], true);
                        }
        ...
        public:
            ...
            class spell_magma_barrage_trigger_SpellScript : public SpellScript
            {
                ...
                void OnSpellHit(SpellEffIndex)
                {
                    ...
                    caster->CastSpell(*l_Dest, (uint32)Spells::MagmaBarrageTrigger, true);
                }
    ...
    class areatrigger_shatter_earth : public AreaTriggerAI
    {
        ...
        public:
            ...
            void OnUpdate(uint32 /*diff*/) override
            {
                ...
                if (l_HasTarget)
                    caster->CastSpell(*at, (uint32)Spells::ShatterEarthSpawn, true);
            }
    };
