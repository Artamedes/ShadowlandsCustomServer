                    ...
                    switch (spellInfo->Id)
                    {
                        ...
                        case eSpells::SpellHeatWaveAuraDummy:
                        {
                            if (Creature* lavaHeatTrigger = me->FindNearestCreature(MobEntries::LavaHeatTrigger, 20.0f))
                            {
                                ...
                                lavaHeatTrigger->SetUnitFlag2(UNIT_FLAG2_CANNOT_TURN);
                            }
                        ...
                        case eSpells::SpellBurningSlagDummy:
                        {
                            ...
                            me->CastSpell(Position(l_SpawnPos.x, l_SpawnPos.y, l_SpawnPos.z), eSpells::SpellBurningSlagMissile, true);
                            --m_BurningSlagCount;
                            break;
                        }
                        default:
                    ...
                    switch (m_Events.ExecuteEvent())
                    {
                        ...
                        case eEvents::EventFieryBoulder:
                        {
                            ...
                            if (m_FieryBoulderCount < eDatas::MaxFieryBoulder)
                                m_Events.ScheduleEvent(eEvents::EventFieryBoulder, 100ms);
                            else
                            {
                                m_FieryBoulderCount = 0;
                        ...
                        case eEvents::EventBurningSlag:
                        {
                            ...
                            else
                            {
                                ...
                                m_Events.ScheduleEvent(eEvents::EventBurningSlag, 550ms);
                            }
                            break;
                        }
                ...
                void UpdateAI(uint32 const diff) override
                {
                    ...
                    switch (m_Events.ExecuteEvent())
                    {
                        case eEvents::EventDealDamage:
                        {
                            ...
                            m_Events.ScheduleEvent(eEvents::EventDealDamage, 500ms);
                            break;
                        }
        ...
        public:
            ...
            void OnUnitEnter(Unit* unit) override
            {
                if (Unit* caster = at->GetCaster())
                {
                    ...
                    {
                        player->ApplyMovementForce(at->GetGUID(), s_HeatWavePos, -7.0f, MovementForceType::Gravity);
