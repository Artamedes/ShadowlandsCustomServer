...
enum CharacterDatabaseStatements : uint32
{
    ...
    */
    ...
    CHAR_DEL_CHAR_ACC_ACHIEVEMENT_BY_ACHIEVEMENT,
    CHAR_UPD_CHAR_ACC_ACHIEVEMENT,
    ...
    CHAR_SEL_CLAIMED_DAILY_REWARDS,
    CHAR_REP_CLAIMED_DAILY_REWARDS,
    CHAR_DEL_CLAIMED_DAILY_REWARDS,
