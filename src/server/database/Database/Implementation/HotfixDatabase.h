...
enum HotfixDatabaseStatements : uint32
{
    ...
    */
    ...
    HOTFIX_SEL_ITEM_BONUS_LIST,
    HOTFIX_SEL_ITEM_BONUS_LIST_MAX_ID,
    ...
    HOTFIX_SEL_UI_COVENANT_ABILITY,
    HOTFIX_SEL_UI_COVENANT_ABILITY_MAX_ID,
    ...
    HOTFIX_SEL_SOULBIND_ENHANCED_CONDUIT,
    HOTFIX_SEL_SOULBIND_ENHANCED_CONDUIT_MAX_ID,
    ...
    HOTFIX_REP_ITEM_MODIFIED_APPERANCE,
