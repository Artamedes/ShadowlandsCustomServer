...
enum WorldDatabaseStatements : uint32
{
    ...
    */
    ...
    WORLD_INS_QUEST_POI,
    WORLD_INS_QUEST_POI_POINTS,
    // CUSTOM
    WORLD_REP_CREATURE_QUESTSTARTER,
    WORLD_REP_CREATURE_QUESTENDER,
    WORLD_REP_QUEST_TEMPLATE,
    WORLD_REP_QUEST_TEMPLATE_ADDON,
    WORLD_REP_QUEST_OBJECTIVES,
    WORLD_REP_QUEST_OFFER_REWARD,

    WORLD_DEL_WP_PATH_NODE,
    WORLD_DEL_WP_ADDON_PATH_NODE,
    WORLD_REP_WAYPOINT_NODE,
    WORLD_REP_WAYPOINT_ADDON_NODE,

    WORLD_REP_Z_SPELL_FIX,
