...
void ChallengeModeMgr::GenerateCurrentWeekAffixes()
{
    uint32 affixes[12][4] =
    {
        ...
        { TYRANNICAL, BOLSTERING, EXPLOSIVES, INFESTED },
        { FORTIFIED, BURSTING, QUAKING, INFESTED },
        { TYRANNICAL, RAGING, VOLCANIC, INFESTED },
        { FORTIFIED, TEEMING, EXPLOSIVES, INFESTED },
...
void ChallengeModeMgr::GetChallengeDoorOrChestPosition(uint32 mapID, float& x, float& y, float& z, float& o, float& rot0, float& rot1, float& rot2, float& rot3, bool door, bool horde)
{
    switch (mapID)
    {
    case CHALLENGE_MAP_ID_SHRINE_OF_THE_STORM: 
