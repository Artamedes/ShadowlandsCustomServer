...
// ... we now have big cities with huge stairs where more points are needed to move one floor up or down
#define MAX_PATH_LENGTH         100 // original 74
#define MAX_POINT_PATH_LENGTH   100 // original 74
...
class TC_GAME_API PathGenerator
{
    public:
        ...
        bool CalculatePath(float destX, float destY, float destZ, G3D::Vector3& start, bool forceDest = false, bool straightLine = false);
