...
class TC_GAME_API CreatureAI : public UnitAI
{
    ...
    public:
        ...
        virtual bool OnBuyItemFromVendorSlot(Player* /*player*/, uint32 /*vendorslot*/, uint32 /*item*/, uint8 /*count*/, uint8 /*bag*/, uint8 /*slot*/, uint64 /*price*/, ItemTemplate const* /*pProto*/, VendorItem const* /*crItem*/) { return true; }
