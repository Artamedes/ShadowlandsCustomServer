...
TC_API_EXPORT EnumText EnumUtils<SpellAttr8>::ToString(SpellAttr8 value)
{
    switch (value)
    {
        ...
        case SPELL_ATTR8_HASTE_AFFECT_DURATION_RECOVERY: return { "SPELL_ATTR8_UNK17", "Unknown attribute 17@Attr8", "" };
...
TC_API_EXPORT SpellAttr8 EnumUtils<SpellAttr8>::FromIndex(size_t index)
{
    switch (index)
    {
        ...
        case 17: return SPELL_ATTR8_HASTE_AFFECT_DURATION_RECOVERY;
...
TC_API_EXPORT size_t EnumUtils<SpellAttr8>::ToIndex(SpellAttr8 value)
{
    switch (value)
    {
        ...
        case SPELL_ATTR8_HASTE_AFFECT_DURATION_RECOVERY: return 17;
