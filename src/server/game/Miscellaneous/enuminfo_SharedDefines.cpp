...
TC_API_EXPORT EnumText EnumUtils<SpellAttr7>::ToString(SpellAttr7 value)
{
    switch (value)
    {
        case SPELL_ATTR7_ALLOW_SPELL_REFLECTION: return { "SPELL_ATTR7_ALLOW_SPELL_REFLECTION", "Unknown attribute 0@Attr7", "" };
        ...
        case SPELL_ATTR7_PREPARE_FOR_VEHICLE_CONTROL_END: return { "SPELL_ATTR7_PREPARE_FOR_VEHICLE_CONTROL_END", "Unknown attribute 7@Attr7", "" };
        ...
        case SPELL_ATTR7_RECAST_ON_RESUMMON: return { "SPELL_ATTR7_RECAST_ON_RESUMMON", "Unknown attribute 14@Attr7", "" };
        ...
        case SPELL_ATTR7_DO_NOT_LOG_PVP_KILL: return { "SPELL_ATTR7_DO_NOT_LOG_PVP_KILL", "Unknown attribute 17@Attr7", "" };
        ...
        case SPELL_ATTR7_REFLECTION_ONLY_DEFENDS: return { "SPELL_ATTR7_REFLECTION_ONLY_DEFENDS", "Unknown attribute 29@Attr7", "" };
        case SPELL_ATTR7_CAN_PROC_FROM_SUPPRESSED_TARGET_PROCS: return { "SPELL_ATTR7_CAN_PROC_FROM_SUPPRESSED_TARGET_PROCS", "Unknown attribute 30@Attr7", "" };
...
TC_API_EXPORT EnumText EnumUtils<SpellAttr8>::ToString(SpellAttr8 value)
{
    switch (value)
    {
        ...
        case SPELL_ATTR8_IGNORE_DYNAMIC_OBJECT_CASTER: return { "SPELL_ATTR8_IGNORE_DYNAMIC_OBJECT_CASTER", "Unknown attribute 1@Attr8", "" };
        case SPELL_ATTR8_REMOVE_OUTSIDE_DUNGEONS_AND_RAIDS: return { "SPELL_ATTR8_REMOVE_OUTSIDE_DUNGEONS_AND_RAIDS", "Unknown attribute 2@Attr8", "" };
        case SPELL_ATTR8_ONLY_TARGET_IF_SAME_CREATOR: return { "SPELL_ATTR8_ONLY_TARGET_IF_SAME_CREATOR", "Unknown attribute 3@Attr8", "" };
        case SPELL_ATTR8_CAN_HIT_AOE_UNTARGETABLE: return { "SPELL_ATTR8_CAN_HIT_AOE_UNTARGETABLE", "Unknown attribute 4@Attr8", "" };
        case SPELL_ATTR8_ALLOW_WHILE_CHARMED: return { "SPELL_ATTR8_ALLOW_WHILE_CHARMED", "Unknown attribute 5@Attr8", "" };
        case SPELL_ATTR8_AURA_REQUIRED_BY_CLIENT: return { "SPELL_ATTR8_AURA_REQUIRED_BY_CLIENT", "Unknown attribute 6@Attr8", "" };
        case SPELL_ATTR8_IGNORE_SANCTUARY: return { "SPELL_ATTR8_IGNORE_SANCTUARY", "Unknown attribute 7@Attr8", "" };
        ...
        case SPELL_ATTR8_ONLY_PLAYERS_CAN_CAST_THIS_SPELL: return { "SPELL_ATTR8_ONLY_PLAYERS_CAN_CAST_THIS_SPELL", "Unknown attribute 11@Attr8", "" };
        case SPELL_ATTR8_AURA_POINTS_ON_CLIENT: return { "SPELL_ATTR8_AURA_POINTS_ON_CLIENT", "Aura Points On Client", "" };
        case SPELL_ATTR8_NOT_IN_SPELLBOOK_UNTIL_LEARNED: return { "SPELL_ATTR8_NOT_IN_SPELLBOOK_UNTIL_LEARNED", "Unknown attribute 13@Attr8", "" };
        case SPELL_ATTR8_TARGET_PROCS_ON_CASTER: return { "SPELL_ATTR8_TARGET_PROCS_ON_CASTER", "Unknown attribute 14@Attr8", "" };
        ...
        case SPELL_ATTR8_ONLY_TARGET_OWN_SUMMONS: return { "SPELL_ATTR8_ONLY_TARGET_OWN_SUMMONS", "Unknown attribute 16@Attr8", "" };
        case SPELL_ATTR8_HASTE_AFFECTS_DURATION: return { "SPELL_ATTR8_HASTE_AFFECTS_DURATION", "SPELL_ATTR8_HASTE_AFFECTS_DURATION", "17 Modify duration on haste" };
        ...
        case SPELL_ATTR8_NO_SUMMON_DEST_FROM_CLIENT_TARGETING_PATHING_REQUIREMENT: return { "SPELL_ATTR8_NO_SUMMON_DEST_FROM_CLIENT_TARGETING_PATHING_REQUIREMENT", "Unknown attribute 21@Attr8", "" };
        case SPELL_ATTR8_MELEE_HASTE_AFFECTS_PERIODIC: return { "SPELL_ATTR8_MELEE_HASTE_AFFECTS_PERIODIC", "SPELL_ATTR8_MELEE_HASTE_AFFECTS_PERIODIC", "Title Melee haste Affects Periodic" };
        ...
        case SPELL_ATTR8_NO_LEVEL_UP_TOAST: return { "SPELL_ATTR8_NO_LEVEL_UP_TOAST", "Unknown attribute 25@Attr8", "" };
        case SPELL_ATTR8_SKIP_IS_KNOWN_CHECK: return { "SPELL_ATTR8_SKIP_IS_KNOWN_CHECK", "Skip Is Known Check", "" };
        case SPELL_ATTR8_AI_FACE_TARGET: return { "SPELL_ATTR8_AI_FACE_TARGET", "Unknown attribute 27@Attr8", "" };
        ...
        case SPELL_ATTR8_DISPLAY_LARGE_AURA_ICON_ON_UNIT_FRAMES_BOSS_AURA: return { "SPELL_ATTR8_DISPLAY_LARGE_AURA_ICON_ON_UNIT_FRAMES_BOSS_AURA", "Unknown attribute 30@Attr8", "" };
        case SPELL_ATTR8_CAN_ATTACK_IMMUNEPC: return { "SPELL_ATTR8_CAN_ATTACK_IMMUNEPC", "Can Attack ImmunePC", "Do not check UNIT_FLAG_IMMUNE_TO_PC in IsValidAttackTarget" };
        default: throw std::out_of_range("value");
    }
}
...
TC_API_EXPORT EnumText EnumUtils<SpellAttr9>::ToString(SpellAttr9 value)
{
    switch (value)
    {
        ...
        case SPELL_ATTR9_UNK15: return { "SPELL_ATTR9_UNK15", "Do Not Display Power Cost", "" };
        case SPELL_ATTR9_UNK16: return { "SPELL_ATTR9_UNK16", "Next modal spell requires same unit target", "" };
        case SPELL_ATTR9_UNK17: return { "SPELL_ATTR9_UNK17", "AutoCast Off By Default", "" };
        case SPELL_ATTR9_UNK18: return { "SPELL_ATTR9_UNK18", "Ignore School Lockout", "" };
        case SPELL_ATTR9_UNK19: return { "SPELL_ATTR9_UNK19", "Allow Dark Simulacrum", "" };
...
TC_API_EXPORT EnumText EnumUtils<SpellAttr10>::ToString(SpellAttr10 value)
{
    switch (value)
    {
        ...
        case SPELL_ATTR10_PROC_COOLDOWN_ON_A_PER_TARGET_BASIS: return { "SPELL_ATTR10_PROC_COOLDOWN_ON_A_PER_TARGET_BASIS", "Unknown attribute 10@Attr10", "" };
...
TC_API_EXPORT EnumText EnumUtils<SpellAttr11>::ToString(SpellAttr11 value)
{
    switch (value)
    {
        ...
        case SPELL_ATTR11_DONT_CLOSE_LOOT_WINDOW: return { "SPELL_ATTR11_DONT_CLOSE_LOOT_WINDOW", "Don't close the loot window, seems to be handled by client", "" };
...
TC_API_EXPORT EnumText EnumUtils<SpellAttr13>::ToString(SpellAttr13 value)
{
    switch (value)
    {
        ...
        case SPELL_ATTR13_CANNOT_LIFESTEALLEECH: return { "SPELL_ATTR13_CANNOT_LIFESTEALLEECH", "cannot proc lifesteal or leech", "" };
        ...
        case SPELL_ATTR13_PERIODIC_REFRESH_EXTENDS_DURATION: return { "SPELL_ATTR13_PERIODIC_REFRESH_EXTENDS_DURATION", "reapplying the aura extends the duration by (1/3) MaxDuration", "" };
