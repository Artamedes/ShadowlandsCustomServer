...
TC_API_EXPORT EnumText EnumUtils<SpellAttr8>::ToString(SpellAttr8 value)
{
    switch (value)
    {
        ...
        case SPELL_ATTR8_HASTE_AFFECT_DURATION: return { "SPELL_ATTR8_HASTE_AFFECT_DURATION", "SPELL_ATTR8_HASTE_AFFECT_DURATION", "22" };
...
TC_API_EXPORT SpellAttr8 EnumUtils<SpellAttr8>::FromIndex(size_t index)
{
    switch (index)
    {
        ...
        case 22: return SPELL_ATTR8_HASTE_AFFECT_DURATION;
...
TC_API_EXPORT size_t EnumUtils<SpellAttr8>::ToIndex(SpellAttr8 value)
{
    switch (value)
    {
        ...
        case SPELL_ATTR8_HASTE_AFFECT_DURATION: return 22;
