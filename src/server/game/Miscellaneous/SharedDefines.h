...
enum SpellAttr7 : uint32
{
    ...
    SPELL_ATTR7_DEBUG_SPELL                                   = 0x00000008, // TITLE Debug Spell
    SPELL_ATTR7_TREAT_AS_RAID_BUFF                            = 0x00000010, // TITLE Treat as Raid Buff
    SPELL_ATTR7_CAN_BE_MULTI_CAST                             = 0x00000020, // TITLE Can Be Multi Cast
    SPELL_ATTR7_DONT_CAUSE_SPELL_PUSHBACK                     = 0x00000040, // TITLE Don't Cause Spell Pushback
    SPELL_ATTR7_PREPARE_FOR_VEHICLE_CONTROL_END               = 0x00000080, // TITLE Prepare for Vehicle Control End
    SPELL_ATTR7_HORDE_SPECIFIC_SPELL                          = 0x00000100, // TITLE Horde Specific Spell
    SPELL_ATTR7_ALLIANCE_SPECIFIC_SPELL                       = 0x00000200, // TITLE Alliance Specific Spell
    SPELL_ATTR7_DISPEL_REMOVES_CHARGES                        = 0x00000400, // TITLE Dispel Removes Charges
    SPELL_ATTR7_CAN_CAUSE_INTERRUPT                           = 0x00000800, // TITLE Can Cause Interrupt
    SPELL_ATTR7_CAN_CAUSE_SILENCE                             = 0x00001000, // TITLE Can Cause Silence
    SPELL_ATTR7_NO_UI_NOT_INTERRUPTIBLE                       = 0x00002000, // TITLE No UI Not Interruptible
    SPELL_ATTR7_RECAST_ON_RESUMMON                            = 0x00004000, // TITLE Recast On Resummon
    SPELL_ATTR7_RESET_SWING_TIMER_AT_SPELL_START              = 0x00008000, // TITLE Reset Swing Timer at spell start
    SPELL_ATTR7_ONLY_IN_SPELLBOOK_UNTIL_LEARNED               = 0x00010000, // TITLE Only In Spellbook Until Learned
    SPELL_ATTR7_DO_NOT_LOG_PVP_KILL                           = 0x00020000, // TITLE Do Not Log PvP Kill
    ...
    SPELL_ATTR7_NO_CLIENT_FAIL_WHILE_STUNNED_FLEEING_CONFUSED = 0x00100000, // TITLE No Client Fail While Stunned, Fleeing, Confused
    SPELL_ATTR7_RETAIN_COOLDOWN_THROUGH_LOAD                  = 0x00200000, // TITLE Retain Cooldown Through Load
...
enum SpellAttr8 : uint32
{
    ...
    SPELL_ATTR8_IGNORE_DYNAMIC_OBJECT_CASTER                             = 0x00000002, // TITLE Ignore Dynamic Object Caster
    ...
    SPELL_ATTR8_ALLOW_WHILE_CHARMED                                      = 0x00000020, // TITLE Allow While Charmed
    SPELL_ATTR8_AURA_REQUIRED_BY_CLIENT                                  = 0x00000040, // TITLE Aura Required by Client
    ...
    SPELL_ATTR8_MIRROR_CREATURE_NAME                                     = 0x00000400, // TITLE Mirror creature name
    ...
    SPELL_ATTR8_NOT_IN_SPELLBOOK_UNTIL_LEARNED                           = 0x00002000, // TITLE Not In Spellbook Until Learned
    SPELL_ATTR8_TARGET_PROCS_ON_CASTER                                   = 0x00004000, // TITLE Target Procs On Caster
    ...
    SPELL_ATTR8_IGNORE_SPELLCAST_OVERRIDE_COST                           = 0x00040000, // TITLE Ignore Spellcast Override Cost
    ...
    SPELL_ATTR8_NO_SUMMON_DEST_FROM_CLIENT_TARGETING_PATHING_REQUIREMENT = 0x00200000, // TITLE No 'Summon + Dest from Client' Targeting Pathing Requirement
    SPELL_ATTR8_MELEE_HASTE_AFFECTS_PERIODIC                             = 0x00400000, // TITLE Melee Haste Affects Periodic
    SPELL_ATTR8_ENFORCE_IN_COMBAT_RESSURECTION_LIMIT                     = 0x00800000, // TITLE Enforce In Combat Ressurection Limit
    ...
    SPELL_ATTR8_AI_FACE_TARGET                                           = 0x08000000, // TITLE AI Face Target
    ...
    SPELL_ATTR8_CAN_ATTACK_IMMUNEPC                                      = 0x80000000  // TITLE Can Attack ImmunePC
};

// EnumUtils: DESCRIBE THIS
enum SpellAttr9 : uint32
{
    SPELL_ATTR9_FORCE_DEST_LOCATION                                 = 0x00000001, // TITLE Force Dest Location
    SPELL_ATTR9_MOD_INVIS_INCLUDES_PARTY                            = 0x00000002, // TITLE Mod Invis Includes Party
    SPELL_ATTR9_ONLY_WHEN_ILLEGALLY_MOUNTED                         = 0x00000004, // TITLE Only When Illegally Mounted
    SPELL_ATTR9_DO_NOT_LOG_AURA_REFRESH                             = 0x00000008, // TITLE Do Not Log Aura Refresh
    ...
    SPELL_ATTR9_DO_NOT_ADD_TO_UNLEARN_LIST                          = 0x00000080, // TITLE Do Not Add to Unlearn List
    ...
    SPELL_ATTR9_ALLOW_WHILE_BANISHED_AURA_STATE                     = 0x00000800, // TITLE Allow While Banished Aura State
    ...
    SPELL_ATTR9_DO_NOT_DISPLAY_POWER_COST                           = 0x00008000, // TITLE Do Not Display Power Cost
    SPELL_ATTR9_NEXT_MODAL_SPELL_REQUIRES_SAME_UNIT_TARGET          = 0x00010000, // TITLE Next modal spell requires same unit target
    ...
    SPELL_ATTR9_SUPPRESS_VISUAL_KIT_ERRORS                          = 0x00200000, // TITLE Suppress Visual Kit Errors
    SPELL_ATTR9_SPELLCAST_OVERRIDE_IN_SPELLBOOK                     = 0x00400000, // TITLE Spellcast Override In Spellbook
    ...
    SPELL_ATTR9_PROGRAMMER_ONLY_DONT_CONSUME_CHARGE_IF_ITEM_DELETED = 0x02000000, // TITLE (Programmer Only) Don't consume charge if item deleted
    SPELL_ATTR9_ITEM_PASSIVE_ON_CLIENT                              = 0x04000000, // TITLE Item Passive On Client
    SPELL_ATTR9_FORCE_CORPSE_TARGET                                 = 0x08000000, // TITLE Force Corpse Target
    SPELL_ATTR9_CANNOT_KILL_TARGET                                  = 0x10000000, // TITLE Cannot Kill Target
    SPELL_ATTR9_LOG_PASSIVE                                         = 0x20000000, // TITLE Log Passive
...
{
    SPELL_ATTR10_BYPASS_VISIBILITY_CHECK                         = 0x00000001, // TITLE Bypass Visibility Check
    SPELL_ATTR10_IGNORE_POSITIVE_DAMAGE_TAKEN_MODIFIERS          = 0x00000002, // TITLE Ignore Positive Damage Taken Modifiers
    SPELL_ATTR10_USES_RANGED_SLOT_COSMETIC_ONLY                  = 0x00000004, // TITLE Uses Ranged Slot (Cosmetic Only)
    SPELL_ATTR10_DO_NOT_LOG_FULL_OVERHEAL                        = 0x00000008, // TITLE Do Not Log Full Overheal
    SPELL_ATTR10_NPC_KNOCKBACK__IGNORE_DOORS                     = 0x00000010, // TITLE NPC Knockback - ignore doors
    SPELL_ATTR10_FORCE_NONBINARY_RESISTANCE                      = 0x00000020, // TITLE Force Non-Binary Resistance
    SPELL_ATTR10_NO_SUMMON_LOG                                   = 0x00000040, // TITLE No Summon Log
    SPELL_ATTR10_IGNORE_INSTANCE_LOCK_AND_FARM_LIMIT_ON_TELEPORT = 0x00000080, // TITLE Ignore instance lock and farm limit on teleport
    SPELL_ATTR10_AREA_EFFECTS_USE_TARGET_RADIUS                  = 0x00000100, // TITLE Area Effects Use Target Radius
    SPELL_ATTR10_CHARGEJUMPCHARGE__USE_ABSOLUTE_SPEED            = 0x00000200, // TITLE Charge/JumpCharge - Use Absolute Speed
    SPELL_ATTR10_PROC_COOLDOWN_ON_A_PER_TARGET_BASIS             = 0x00000400, // TITLE Proc cooldown on a per target basis
    SPELL_ATTR10_LOCK_CHEST_AT_PRECAST                           = 0x00000800, // TITLE Lock chest at precast
    ...
    SPELL_ATTR10_ROLLING_PERIODIC                                = 0x00004000, // TITLE Rolling Periodic
    SPELL_ATTR10_SPELLBOOK_HIDDEN_UNTIL_OVERRIDDEN               = 0x00008000, // TITLE Spellbook Hidden Until Overridden
    SPELL_ATTR10_DEFEND_AGAINST_FRIENDLY_CAST                    = 0x00010000, // TITLE Defend Against Friendly Cast
    SPELL_ATTR10_ALLOW_DEFENSE_WHILE_CASTING                     = 0x00020000, // TITLE Allow Defense While Casting
    SPELL_ATTR10_ALLOW_DEFENSE_WHILE_CHANNELING                  = 0x00040000, // TITLE Allow Defense While Channeling
    SPELL_ATTR10_ALLOW_FATAL_DUEL_DAMAGE                         = 0x00080000, // TITLE Allow Fatal Duel Damage
    SPELL_ATTR10_MULTICLICK_GROUND_TARGETING                     = 0x00100000, // TITLE Multi-Click Ground Targeting
    SPELL_ATTR10_AOE_CAN_HIT_SUMMONED_INVIS                      = 0x00200000, // TITLE AoE Can Hit Summoned Invis
    SPELL_ATTR10_ALLOW_WHILE_STUNNED_BY_HORROR_MECHANIC          = 0x00400000, // TITLE Allow While Stunned By Horror Mechanic
    SPELL_ATTR10_VISIBLE_ONLY_TO_CASTER_CONVERSATIONS_ONLY       = 0x00800000, // TITLE Visible only to caster (conversations only)
    SPELL_ATTR10_UPDATE_PASSIVES_ON_APPLYREMOVE                  = 0x01000000, // TITLE Update Passives on Apply/Remove
    SPELL_ATTR10_NORMAL_MELEE_ATTACK                             = 0x02000000, // TITLE Normal Melee Attack
    SPELL_ATTR10_IGNORE_FEIGN_DEATH                              = 0x04000000, // TITLE Ignore Feign Death
    SPELL_ATTR10_CASTER_DEATH_CANCELS_PERSISTENT_AREA_AURAS      = 0x08000000, // TITLE Caster Death Cancels Persistent Area Auras
    SPELL_ATTR10_DO_NOT_LOG_ABSORB                               = 0x10000000, // TITLE Do Not Log Absorb
    SPELL_ATTR10_THIS_MOUNT_IS_NOT_AT_THE_ACCOUNT_LEVEL          = 0x20000000, // TITLE This Mount is NOT at the account level
    SPELL_ATTR10_PREVENT_CLIENT_CAST_CANCEL                      = 0x40000000, // TITLE Prevent Client Cast Cancel
    SPELL_ATTR10_ENFORCE_FACING_ON_PRIMARY_TARGET_ONLY           = 0x80000000  // TITLE Enforce Facing on Primary Target Only
};

// EnumUtils: DESCRIBE THIS
enum SpellAttr11 : uint32
{
    SPELL_ATTR11_LOCK_CASTER_MOVEMENT_AND_FACING_WHILE_CASTING     = 0x00000001, // TITLE Lock Caster Movement and Facing While Casting
    SPELL_ATTR11_DONT_CANCEL_WHEN_ALL_EFFECTS_ARE_DISABLED         = 0x00000002, // TITLE Don't Cancel When All Effects are Disabled
    SPELL_ATTR11_SCALES_WITH_CASTING_ITEMS_LEVEL                   = 0x00000004, // TITLE Scales with Casting Item's Level
    SPELL_ATTR11_DO_NOT_LOG_ON_LEARN                               = 0x00000008, // TITLE Do Not Log on Learn
    SPELL_ATTR11_HIDE_SHAPESHIFT_REQUIREMENTS                      = 0x00000010, // TITLE Hide Shapeshift Requirements
    SPELL_ATTR11_ABSORB_FALLING_DAMAGE                             = 0x00000020, // TITLE Absorb Falling Damage
    SPELL_ATTR11_UNBREAKABLE_CHANNEL                               = 0x00000040, // TITLE Unbreakable Channel
    SPELL_ATTR11_IGNORE_CASTERS_SPELL_LEVEL                        = 0x00000080, // TITLE Ignore Caster's spell level
    SPELL_ATTR11_TRANSFER_MOUNT_SPELL                              = 0x00000100, // TITLE Transfer Mount Spell
    ...
    SPELL_ATTR11_NEWEST_EXCLUSIVE_COMPLETE                         = 0x00000400, // TITLE Newest Exclusive Complete
    SPELL_ATTR11_NOT_IN_INSTANCES                                  = 0x00000800, // TITLE Not in Instances
    SPELL_ATTR11_OBSOLETE                                          = 0x00001000, // TITLE Obsolete
    SPELL_ATTR11_IGNORE_PVP_POWER                                  = 0x00002000, // TITLE Ignore PvP Power
    SPELL_ATTR11_CAN_ASSIST_UNINTERACTIBLE                         = 0x00004000, // TITLE Can Assist Uninteractible
    SPELL_ATTR11_CAST_WHEN_INITIAL_LOGGING_IN                      = 0x00008000, // TITLE Cast When Initial Logging In
    SPELL_ATTR11_NOT_IN_MYTHIC_MODE_CHALLENGE_MODE                 = 0x00010000, // TITLE Not in Mythic+ Mode (Challenge Mode)
    SPELL_ATTR11_CHEAPER_NPC_KNOCKBACK                             = 0x00020000, // TITLE Cheaper NPC Knockback
    ...
    SPELL_ATTR11_HIDE_LOSS_OF_CONTROL_UI                           = 0x00100000, // TITLE Hide Loss of Control UI
    SPELL_ATTR11_ALLOW_HARMFUL_ON_FRIENDLY                         = 0x00200000, // TITLE Allow Harmful on Friendly
    SPELL_ATTR11_CHEAP_MISSILE_AOI                                 = 0x00400000, // TITLE Cheap Missile AOI
    SPELL_ATTR11_EXPENSIVE_MISSILE_AOI                             = 0x00800000, // TITLE Expensive Missile AOI
    SPELL_ATTR11_NO_CLIENT_FAIL_ON_NO_PET                          = 0x01000000, // TITLE No Client Fail on No Pet
    SPELL_ATTR11_AI_ATTEMPT_CAST_ON_IMMUNE_PLAYER                  = 0x02000000, // TITLE AI Attempt Cast on Immune Player
    SPELL_ATTR11_ALLOW_WHILE_STUNNED_BY_STUN_MECHANIC              = 0x04000000, // TITLE Allow While Stunned by Stun Mechanic
    SPELL_ATTR11_DONT_CLOSE_LOOT_WINDOW                            = 0x08000000, // TITLE Don't close loot window
    SPELL_ATTR11_HIDE_DAMAGE_ABSORB_UI                             = 0x10000000, // TITLE Hide Damage Absorb UI
    SPELL_ATTR11_DO_NOT_TREAT_AS_AREA_EFFECT                       = 0x20000000, // TITLE Do Not Treat As Area Effect
    SPELL_ATTR11_CHECK_REQUIRED_TARGET_AURA_BY_CASTER              = 0x40000000, // TITLE Check Required Target Aura By Caster
    SPELL_ATTR11_APPLY_ZONE_AURA_SPELL_TO_PETS                     = 0x80000000  // TITLE Apply Zone Aura Spell To Pets
};
...
enum SpellAttr12 : uint32
{
    ...
    SPELL_ATTR12_SHOW_COOLDOWN_AS_CHARGE_UP                                    = 0x00000004, // TITLE Show Cooldown As Charge Up
    SPELL_ATTR12_NO_PVP_BATTLE_FATIGUE                                         = 0x00000008, // TITLE No PvP Battle Fatigue
    SPELL_ATTR12_TREAT_SELF_CAST_AS_REFLECT                                    = 0x00000010, // TITLE Treat Self Cast As Reflect
    SPELL_ATTR12_DO_NOT_CANCEL_AREA_AURA_ON_SPEC_SWITCH                        = 0x00000020, // TITLE Do Not Cancel Area Aura on Spec Switch
    SPELL_ATTR12_COOLDOWN_ON_AURA_CANCEL_UNTIL_COMBAT_ENDS                     = 0x00000040, // TITLE Cooldown on Aura Cancel Until Combat Ends
    SPELL_ATTR12_DO_NOT_REAPPLY_AREA_AURA_IF_IT_PERSISTS_THROUGH_UPDATE        = 0x00000080, // TITLE Do Not Re-apply Area Aura if it Persists Through Update
    SPELL_ATTR12_DISPLAY_TOAST_MESSAGE                                         = 0x00000100, // TITLE Display Toast Message
    SPELL_ATTR12_ACTIVE_PASSIVE                                                = 0x00000200, // TITLE Active Passive
    SPELL_ATTR12_IGNORE_DAMAGE_CANCELS_AURA_INTERRUPT                          = 0x00000400, // TITLE Ignore Damage Cancels Aura Interrupt
    SPELL_ATTR12_FACE_DESTINATION                                              = 0x00000800, // TITLE Face Destination
    SPELL_ATTR12_IMMUNITY_PURGES_SPELL                                         = 0x00001000, // TITLE Immunity Purges Spell
    SPELL_ATTR12_DO_NOT_LOG_SPELL_MISS                                         = 0x00002000, // TITLE Do Not Log Spell Miss
    SPELL_ATTR12_IGNORE_DISTANCE_CHECK_ON_CHARGEJUMP_CHARGE_DONE_TRIGGER_SPELL = 0x00004000, // TITLE Ignore Distance Check On Charge/Jump Charge Done Trigger Spell
    SPELL_ATTR12_DISABLE_KNOWN_SPELLS_WHILE_CHARMED                            = 0x00008000, // TITLE Disable known spells while charmed
    SPELL_ATTR12_IGNORE_DAMAGE_ABSORB                                          = 0x00010000, // TITLE Ignore Damage Absorb
    SPELL_ATTR12_NOT_IN_PROVING_GROUNDS                                        = 0x00020000, // TITLE Not In Proving Grounds
    SPELL_ATTR12_OVERRIDE_DEFAULT_SPELLCLICK_RANGE                             = 0x00040000, // TITLE Override Default SpellClick Range
    SPELL_ATTR12_IS_INGAME_STORE_EFFECT                                        = 0x00080000, // TITLE Is In-Game Store Effect
    SPELL_ATTR12_ALLOW_DURING_SPELL_OVERRIDE                                   = 0x00100000, // TITLE Allow during spell override
    SPELL_ATTR12_USE_FLOAT_VALUES_FOR_SCALING_AMOUNTS                          = 0x00200000, // TITLE Use float values for scaling amounts
    SPELL_ATTR12_SUPPRESS_TOASTS_ON_ITEM_PUSH                                  = 0x00400000, // TITLE Suppress toasts on item push
    SPELL_ATTR12_TRIGGER_COOLDOWN_ON_SPELL_START                               = 0x00800000, // TITLE Trigger Cooldown On Spell Start
    SPELL_ATTR12_NEVER_LEARN                                                   = 0x01000000, // TITLE Never Learn
    SPELL_ATTR12_NO_DEFLECT                                                    = 0x02000000, // TITLE No Deflect
    SPELL_ATTR12_DEPRECATED_USE_STARTOFCAST_LOCATION_FOR_SPELL_DEST            = 0x04000000, // TITLE (Deprecated) Use Start-of-Cast Location for Spell Dest
    SPELL_ATTR12_RECOMPUTE_AURA_ON_MERCENARY_MODE                              = 0x08000000, // TITLE Recompute Aura on Mercenary Mode
    SPELL_ATTR12_USE_WEIGHTED_RANDOM_FOR_FLEX_MAX_TARGETS                      = 0x10000000, // TITLE Use Weighted Random For Flex Max Targets
    SPELL_ATTR12_IGNORE_RESILIENCE                                             = 0x20000000, // TITLE Ignore Resilience
    SPELL_ATTR12_APPLY_RESILIENCE_TO_SELF_DAMAGE                               = 0x40000000, // TITLE Apply Resilience To Self Damage
...
enum SpellAttr13 : uint32
{
    ...
    SPELL_ATTR13_ALLOW_WHILE_FEARED_BY_FEAR_MECHANIC             = 0x00000002, // TITLE Allow While Feared By Fear Mechanic
    SPELL_ATTR13_COOLDOWN_SHARED_WITH_AI_GROUP                   = 0x00000004, // TITLE Cooldown Shared With AI Group
    SPELL_ATTR13_INTERRUPTS_CURRENT_CAST                         = 0x00000008, // TITLE Interrupts Current Cast
    SPELL_ATTR13_PERIODIC_SCRIPT_RUNS_LATE                       = 0x00000010, // TITLE Periodic Script Runs Late
    SPELL_ATTR13_RECIPE_HIDDEN_UNTIL_KNOWN                       = 0x00000020, // TITLE Recipe Hidden Until Known
    SPELL_ATTR13_CAN_PROC_FROM_LIFESTEAL                         = 0x00000040, // TITLE Can Proc From Lifesteal
    SPELL_ATTR13_NAMEPLATE_PERSONAL_BUFFSDEBUFFS                 = 0x00000080, // TITLE Nameplate Personal Buffs/Debuffs
    SPELL_ATTR13_CANNOT_LIFESTEALLEECH                           = 0x00000100, // TITLE Cannot Lifesteal/Leech
    SPELL_ATTR13_GLOBAL_AURA                                     = 0x00000200, // TITLE Global Aura
    SPELL_ATTR13_NAMEPLATE_ENEMY_DEBUFFS                         = 0x00000400, // TITLE Nameplate Enemy Debuffs
    SPELL_ATTR13_ALWAYS_ALLOW_PVP_FLAGGED_TARGET                 = 0x00000800, // TITLE Always Allow PvP Flagged Target
    SPELL_ATTR13_DO_NOT_CONSUME_AURA_STACK_ON_PROC               = 0x00001000, // TITLE Do Not Consume Aura Stack On Proc
    SPELL_ATTR13_DO_NOT_PVP_FLAG_CASTER                          = 0x00002000, // TITLE Do Not PvP Flag Caster
    SPELL_ATTR13_ALWAYS_REQUIRE_PVP_TARGET_MATCH                 = 0x00004000, // TITLE Always Require PvP Target Match
    SPELL_ATTR13_DO_NOT_FAIL_IF_NO_TARGET                        = 0x00008000, // TITLE Do Not Fail if No Target
    SPELL_ATTR13_DISPLAYED_OUTSIDE_OF_SPELLBOOK                  = 0x00010000, // TITLE Displayed Outside Of Spellbook
    SPELL_ATTR13_CHECK_PHASE_ON_STRING_ID_RESULTS                = 0x00020000, // TITLE Check Phase on String ID Results
    SPELL_ATTR13_DO_NOT_ENFORCE_SHAPESHIFT_REQUIREMENTS          = 0x00040000, // TITLE Do Not Enforce Shapeshift Requirements
    SPELL_ATTR13_AURA_PERSISTS_THROUGH_TAME_PET                  = 0x00080000, // TITLE Aura Persists Through Tame Pet
    SPELL_ATTR13_PERIODIC_REFRESH_EXTENDS_DURATION               = 0x00100000, // TITLE Periodic Refresh Extends Duration DESCRIPTION Applys up to 1/3 the duration on top of current duration
    SPELL_ATTR13_USE_SKILL_RANK_AS_SPELL_LEVEL                   = 0x00200000, // TITLE Use Skill Rank As Spell Level
    SPELL_ATTR13_AURA_ALWAYS_SHOWN                               = 0x00400000, // TITLE Aura Always Shown
    SPELL_ATTR13_USE_SPELL_LEVEL_FOR_ITEM_SQUISH_COMPENSATION    = 0x00800000, // TITLE Use Spell Level For Item Squish Compensation
    SPELL_ATTR13_CHAIN_BY_MOST_HIT                               = 0x01000000, // TITLE Chain by Most Hit
    SPELL_ATTR13_DO_NOT_DISPLAY_CAST_TIME                        = 0x02000000, // TITLE Do Not Display Cast Time
    ...
    SPELL_ATTR13_ALLOW_AURA_ON_LEVEL_SCALE                       = 0x10000000, // TITLE Allow Aura On Level Scale
    SPELL_ATTR13_REMOVE_AURA_ON_LEVEL_SCALE                      = 0x20000000, // TITLE Remove Aura On Level Scale
    SPELL_ATTR13_RECOMPUTE_AURA_ON_LEVEL_SCALE                   = 0x40000000, // TITLE Recompute Aura On Level Scale
    SPELL_ATTR13_UPDATE_FALL_SPEED_AFTER_AURA_REMOVAL            = 0x80000000  // TITLE Update Fall Speed After Aura Removal
};
...
enum Targets
{
    ...
    TARGET_UNK_146                              = 146,
    TARGET_UNK_147                              = 147,
    TARGET_DEST_TARGET_ENEMY_BACK               = 148,
    TARGET_UNK_149                              = 149,
...
enum UnitDynFlags
{
    ...
    UNIT_DYNFLAG_LOOTABLE                   = 0x0004, // Show this flag if in personal list.
    ...
    UNIT_DYNFLAG_CAN_SKIN                   = 0x0040, ///< Brings up the skinning right click (valid 9.2.7)
