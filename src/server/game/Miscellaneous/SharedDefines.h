...
{
    SPELL_ATTR7_ALLOW_SPELL_REFLECTION                        = 0x00000001, // TITLE Unknown attribute 0@Attr7
    ...
    SPELL_ATTR7_PREPARE_FOR_VEHICLE_CONTROL_END               = 0x00000080, // TITLE Unknown attribute 7@Attr7
    ...
    SPELL_ATTR7_RECAST_ON_RESUMMON                            = 0x00004000, // TITLE Unknown attribute 14@Attr7
    ...
    SPELL_ATTR7_DO_NOT_LOG_PVP_KILL                           = 0x00020000, // TITLE Unknown attribute 17@Attr7
    ...
    SPELL_ATTR7_REFLECTION_ONLY_DEFENDS                       = 0x20000000, // TITLE Unknown attribute 29@Attr7
    SPELL_ATTR7_CAN_PROC_FROM_SUPPRESSED_TARGET_PROCS         = 0x40000000, // TITLE Unknown attribute 30@Attr7
...
enum SpellAttr8 : uint32
{
    ...
    SPELL_ATTR8_IGNORE_DYNAMIC_OBJECT_CASTER                             = 0x00000002, // TITLE Unknown attribute 1@Attr8
    SPELL_ATTR8_REMOVE_OUTSIDE_DUNGEONS_AND_RAIDS                        = 0x00000004, // TITLE Unknown attribute 2@Attr8
    SPELL_ATTR8_ONLY_TARGET_IF_SAME_CREATOR                              = 0x00000008, // TITLE Unknown attribute 3@Attr8
    SPELL_ATTR8_CAN_HIT_AOE_UNTARGETABLE                                 = 0x00000010, // TITLE Unknown attribute 4@Attr8
    SPELL_ATTR8_ALLOW_WHILE_CHARMED                                      = 0x00000020, // TITLE Unknown attribute 5@Attr8
    SPELL_ATTR8_AURA_REQUIRED_BY_CLIENT                                  = 0x00000040, // TITLE Unknown attribute 6@Attr8
    SPELL_ATTR8_IGNORE_SANCTUARY                                         = 0x00000080, // TITLE Unknown attribute 7@Attr8
    ...
    SPELL_ATTR8_ONLY_PLAYERS_CAN_CAST_THIS_SPELL                         = 0x00000800, // TITLE Unknown attribute 11@Attr8
    SPELL_ATTR8_AURA_POINTS_ON_CLIENT                                    = 0x00001000, // TITLE Aura Points On Client
    SPELL_ATTR8_NOT_IN_SPELLBOOK_UNTIL_LEARNED                           = 0x00002000, // TITLE Unknown attribute 13@Attr8
    SPELL_ATTR8_TARGET_PROCS_ON_CASTER                                   = 0x00004000, // TITLE Unknown attribute 14@Attr8
    SPELL_ATTR8_REQUIRES_LOCATION_TO_BE_ON_LIQUID_SURFACE                = 0x00008000, // TITLE Requires location to be on liquid surface
    SPELL_ATTR8_ONLY_TARGET_OWN_SUMMONS                                  = 0x00010000, // TITLE Unknown attribute 16@Attr8
    SPELL_ATTR8_HASTE_AFFECTS_DURATION                                   = 0x00020000, // 17 Modify duration on haste
    ...
    SPELL_ATTR8_NO_SUMMON_DEST_FROM_CLIENT_TARGETING_PATHING_REQUIREMENT = 0x00200000, // TITLE Unknown attribute 21@Attr8
    ...
    SPELL_ATTR8_NO_LEVEL_UP_TOAST                                        = 0x02000000, // TITLE Unknown attribute 25@Attr8
    SPELL_ATTR8_SKIP_IS_KNOWN_CHECK                                      = 0x04000000, // TITLE Skip Is Known Check
    SPELL_ATTR8_AI_FACE_TARGET                                           = 0x08000000, // TITLE Unknown attribute 27@Attr8
    ...
    SPELL_ATTR8_DISPLAY_LARGE_AURA_ICON_ON_UNIT_FRAMES_BOSS_AURA         = 0x40000000, // TITLE Unknown attribute 30@Attr8
    SPELL_ATTR8_CAN_ATTACK_IMMUNEPC                                      = 0x80000000  // TITLE Can Attack ImmunePC DESCRIPTION Do not check UNIT_FLAG_IMMUNE_TO_PC in IsValidAttackTarget
};
...
enum SpellAttr9 : uint32
{
    ...
    SPELL_ATTR9_UNK15                            = 0x00008000, // TITLE Do Not Display Power Cost
    SPELL_ATTR9_UNK16                            = 0x00010000, // TITLE Next modal spell requires same unit target
    SPELL_ATTR9_UNK17                            = 0x00020000, // TITLE AutoCast Off By Default
    SPELL_ATTR9_UNK18                            = 0x00040000, // TITLE Ignore School Lockout
    SPELL_ATTR9_UNK19                            = 0x00080000, // TITLE Allow Dark Simulacrum
...
enum SpellAttr10 : uint32
{
    ...
    SPELL_ATTR10_PROC_COOLDOWN_ON_A_PER_TARGET_BASIS = 0x00000400, // TITLE Unknown attribute 10@Attr10
...
enum SpellAttr13 : uint32
{
    ...
    SPELL_ATTR13_DO_NOT_CONSUME_AURA_STACK_ON_PROC = 0x00001000, // TITLE Unknown attribute 12@Attr13
    ...
    SPELL_ATTR13_PERIODIC_REFRESH_EXTENDS_DURATION = 0x00100000, // TITLE reapplying the aura extends the duration by (1/3) MaxDuration
