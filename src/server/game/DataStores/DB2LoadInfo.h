...
struct GossipNpcOptionLoadInfo
{
    ...
    static constexpr DB2LoadInfo Instance{ Fields, 16, &GossipNPCOptionMeta::Instance, HOTFIX_SEL_GOSSIP_N_P_C_OPTION };
};
...
struct ItemBonusListLoadInfo
{
    ...
    static constexpr DB2LoadInfo Instance{ Fields, 2, &ItemBonusListMeta::Instance, HOTFIX_SEL_ITEM_BONUS_LIST };
};
...
struct UiCovenantAbilityLoadInfo
{
    ...
    static constexpr DB2LoadInfo Instance{ Fields, 5, &UICovenantAbilityMeta::Instance, HOTFIX_SEL_UI_COVENANT_ABILITY };
};
...
struct QuestLineLoadInfo
{
    ...
    static constexpr DB2LoadInfo Instance{ Fields, 5, &QuestLineMeta::Instance, HOTFIX_SEL_QUEST_LINE };
};
