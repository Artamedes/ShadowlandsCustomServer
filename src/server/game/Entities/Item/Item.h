...
struct BonusData
{
    ...
    bool AddBonusList(uint32 bonusListId);
    bool AddBonus(uint32 type, std::array<int32, 4> const& values);
...
class TC_GAME_API Item : public Object
{
    ...
    public:
        ...
        static std::string GetItemLink(Item* item, Player* player = nullptr);
