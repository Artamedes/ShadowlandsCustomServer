...
class TC_GAME_API Unit : public WorldObject
{
    ...
    public:
        ...
        void SetModCastingSpeedNeg(float castingSpeed) { SetUpdateFieldValue(m_values.ModifyValue(&Unit::m_unitData).ModifyValue(&UF::UnitData::ModCastingSpeedNeg), castingSpeed); }
        ...
        void RemoveAurasWithInterruptFlags(SpellAuraInterruptFlags flag, SpellInfo const* source = nullptr);
        void RemoveAurasWithInterruptFlags(SpellAuraInterruptFlags2 flag, SpellInfo const* source = nullptr);
        ...
        UF::DynamicUpdateField<ObjectGuid, 0, 4> GetChannelObjects() const { return m_unitData->ChannelObjects; }
        ...
        SpellInfo const* FindMatchingAuraEffectIn(SpellInfo const* spellInfo, AuraType type);
        virtual SpellInfo const* GetCastSpellInfo(SpellInfo const* spellInfo);
        uint32 GetCastSpellXSpellVisualId(SpellInfo const* spellInfo) const override;
        uint32 m_spellInfoTries = 0;
