...
void Object::BuildCreateUpdateBlockForPlayer(UpdateData* data, Player* target) const
{
   ...
   //
    ...
    switch (GetGUID().GetHigh())
    {
        ...
        case HighGuid::MobileSession:
        case HighGuid::RaidGroup:
        case HighGuid::Spell:
        case HighGuid::Mail:
        case HighGuid::WebObj:
        case HighGuid::LFGObject:
        case HighGuid::LFGList:
        ...
        case HighGuid::ClubFinder:
        case HighGuid::ToolsClient:
        case HighGuid::WorldLayer:
        case HighGuid::ArenaTeam:
        default:
            return;
    }
