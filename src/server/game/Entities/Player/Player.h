...
enum PlayerLoginQueryIndex
{
    ...
    PLAYER_LOGIN_QUERY_LOAD_ACC_ACHIEVEMENTS,
...
class TC_GAME_API Player : public Unit, public GridObject<Player>
{
    ...
    public:
        ...
        InventoryResult CanEquipUniqueItem(ItemTemplate const* itemProto, uint8 except_slot = NULL_SLOT, uint32 limit_count = 1, Item* item = nullptr) const;
        ...
        */
        ...
        SpellInfo const* GetCastSpellInfo(SpellInfo const* spellInfo) override;
        ...
        void UpdateZone(uint32 newZone, uint32 newArea, bool updatePhasing = true);
        void UpdateArea(uint32 newArea, bool updatePhasing = true);
        ...
        void UpdateSpellDamageAndHealingBonus(bool checkAuras = true);
