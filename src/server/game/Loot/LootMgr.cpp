...
uint32 LootStore::LoadLootTable()
{
    ...
    QueryResult result = WorldDatabase.PQuery("SELECT Entry, Type, Item, Reference, Chance, QuestRequired, LootMode, GroupId, MinCount, MaxCount, BonusList FROM {}", GetName());
