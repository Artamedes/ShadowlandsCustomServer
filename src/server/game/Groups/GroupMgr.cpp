...
void GroupMgr::LoadGroups()
{
    ...
    TC_LOG_INFO("server.loading", "Loading Group instance saves...");
    {
        ...
        do
        {
            ...
            InstanceSave* save = sInstanceSaveMgr->AddInstanceSave(mapEntry->ID, fields[2].GetUInt32(), Difficulty(diff), fields[5].GetInt64(), fields[6].GetUInt32(), 0, fields[7].GetUInt64() == 0, true);
