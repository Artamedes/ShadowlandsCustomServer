...
class TC_GAME_API Group
{
    ...
    public:
        ...
        void PersonalLoot(Loot& loot, WorldObject* pLootedObject);
        void DoRollForAllMembers(ObjectGuid guid, uint8 slot, uint32 mapid, Loot* loot, LootItem& item, Player* player);
