...
#define DEFINE_HANDLER(opcode, status, processing, handler) \
    ...
    DEFINE_HANDLER(CMSG_CLASS_TALENTS_NOTIFY_EMPTY_CONFIG,                  STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleSwapLoadoutOpcode);
    ...
    DEFINE_HANDLER(CMSG_TRAITS_COMMIT_CONFIG,                               STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleLearnTraitsOpcode);
    DEFINE_HANDLER(CMSG_CLASS_TALENTS_REQUEST_NEW_CONFIG,                   STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleCreateNewLoadoutOpcode);
    DEFINE_HANDLER(CMSG_CLASS_TALENTS_RENAME_CONFIG,                        STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleRenameLoadout);
    DEFINE_HANDLER(CMSG_CLASS_TALENTS_DELETE_CONFIG,                        STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleRemoveLoadout);
    DEFINE_HANDLER(CMSG_CLASS_TALENTS_SET_STARTER_BUILD_ACTIVE,                             STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleActivateStarterBuild);
...
#define DEFINE_SERVER_OPCODE_HANDLER(opcode, status, con) \
  ...
  //  DEFINE_SERVER_OPCODE_HANDLER(SMSG_PLAYER_SHOW_UI_EVENT_TOAST,              STATUS_NEVER,    CONNECTION_TYPE_REALM);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_QUERY_PLAYER_NAMES_RESPONSE,             STATUS_NEVER, CONNECTION_TYPE_INSTANCE);
