...
enum OpcodeServer : uint16
{
    ...
    SMSG_ON_CANCEL_EXPECTED_RIDE_VEHICLE_AURA                     = 0x26DF,
    SMSG_CRITERIA_DELETED                                         = 0x26E0,
    SMSG_ACHIEVEMENT_DELETED                                      = 0x26E1,
    SMSG_LEVEL_UP_INFO                                            = 0x26E2,
    SMSG_ITEM_CHANGED                                             = 0x26E4,
