...
enum OpcodeClient : uint16
{
    ...
    CMSG_ASSIGN_EQUIPMENT_SET_SPEC                         = 0x3214,
    ...
    CMSG_GARRISON_RESEARCH_TALENT                          = 0x32FA,
    CMSG_GARRISON_LEARN_TALENT                             = 0x3302,
    ...
    CMSG_GARRISON_SOCKET_TALENT                            = 0x33E5,
