...
enum OpcodeClient : uint16
{
    ...
    CMSG_ASSIGN_EQUIPMENT_SET_SPEC                         = 0x3211 + 0x3,
    CMSG_CONFIRM_RESPEC_WIPE                               = 0x3213 + 0x3,
    CMSG_LOOT_UNIT                                         = 0x3214 + 0x3,
    CMSG_LOOT_MONEY                                        = 0x3215 + 0x3,
    CMSG_LOOT_ITEM                                         = 0x3216 + 0x3,
    CMSG_MASTER_LOOT_ITEM                                  = 0x3217 + 0x3,
    CMSG_DO_MASTER_LOOT_ROLL                               = 0x3218 + 0x3,
    CMSG_CANCEL_MASTER_LOOT_ROLL                           = 0x3219 + 0x3,
    CMSG_LOOT_RELEASE                                      = 0x321A + 0x3,
    CMSG_LOOT_ROLL                                         = 0x321B + 0x3,
    CMSG_SCENE_PLAYBACK_COMPLETE                           = 0x3227 + 0x3,
    CMSG_SCENE_PLAYBACK_CANCELED                           = 0x3228 + 0x3,
    CMSG_SCENE_TRIGGER_EVENT                               = 0x3229 + 0x3,
    CMSG_SET_DIFFICULTY_ID                                 = 0x322A + 0x3,
    CMSG_KEYBOUND_OVERRIDE                                 = 0x322B + 0x3,
    CMSG_PET_BATTLE_QUEUE_PROPOSE_MATCH_RESULT             = 0x322C + 0x3,
    CMSG_MAIL_DELETE                                       = 0x322D + 0x3,
    CMSG_SET_ACHIEVEMENTS_HIDDEN                           = 0x322E + 0x3,
    CMSG_MAKE_CONTITIONAL_APPEARANCE_PERMANENT             = 0x322F + 0x3,
    CMSG_PERFORM_ITEM_INTERACTION                          = 0x3237 + 0x3,
    CMSG_REQUEST_VEHICLE_EXIT                              = 0x3241 + 0x3,
    CMSG_REQUEST_VEHICLE_PREV_SEAT                         = 0x3242 + 0x3,
    CMSG_REQUEST_VEHICLE_NEXT_SEAT                         = 0x3243 + 0x3,
    CMSG_REQUEST_VEHICLE_SWITCH_SEAT                       = 0x3244 + 0x3,
    CMSG_RIDE_VEHICLE_INTERACT                             = 0x3245 + 0x3,
    CMSG_EJECT_PASSENGER                                   = 0x3246 + 0x3,
    CMSG_USE_CRITTER_ITEM                                  = 0x324B + 0x3,
    CMSG_CHECK_IS_ADVENTURE_MAP_POI_VALID                  = 0x3251 + 0x3,
    CMSG_ATTACK_SWING                                      = 0x325F + 0x3,
    CMSG_ATTACK_STOP                                       = 0x3260 + 0x3,
    CMSG_CANCEL_CHANNELLING                                = 0x3278,
    CMSG_CANCEL_GROWTH_AURA                                = 0x327D,
    CMSG_QUERY_CREATURE                                    = 0x327E + 0x6,
    CMSG_QUERY_GAME_OBJECT                                 = 0x327F + 0x6,
    CMSG_QUERY_NPC_TEXT                                    = 0x3280 + 0x6,
    CMSG_QUERY_QUEST_INFO                                  = 0x3281 + 0x6,
    CMSG_QUERY_PAGE_TEXT                                   = 0x3282 + 0x6,
    CMSG_QUERY_PET_NAME                                    = 0x3283 + 0x6,
    CMSG_QUERY_BATTLE_PET_NAME                             = 0x3284 + 0x6,
    CMSG_QUERY_GARRISON_PET_NAME                           = 0x3285 + 0x6,
    CMSG_QUERY_PETITION                                    = 0x3286 + 0x6,
    CMSG_REQUEST_PLAYED_TIME                               = 0x3289 + 0x6,
    CMSG_SET_TITLE                                         = 0x328F + 0x6,
    CMSG_CANCEL_MOUNT_AURA                                 = 0x3290 + 0x6,
    CMSG_MOUNT_SPECIAL_ANIM                                = 0x3291 + 0x6,
    CMSG_DESTROY_ITEM                                      = 0x32A2 + 0x8,
    CMSG_GET_MIRROR_IMAGE_DATA                             = 0x32A6 + 0x8,
    CMSG_USE_ITEM                                          = 0x32A7 + 0x8,
    CMSG_ADD_TOY                                           = 0x32A8 + 0x8,
    CMSG_ADD_ACCOUNT_COSMETIC                              = 0x32A9 + 0x8,
    CMSG_USE_TOY                                           = 0x32AA + 0x8,
    CMSG_PET_CAST_SPELL                                    = 0x32AB + 0x8,
    CMSG_CAST_SPELL                                        = 0x32AC + 0x8, // 8 diff here
    CMSG_UPDATE_SPELL_VISUAL                               = 0x32AD + 0x8,
    CMSG_UPDATE_AREA_TRIGGER_VISUAL                        = 0x32AE + 0x8,
    CMSG_CANCEL_CAST                                       = 0x32AF + 0x8,
    CMSG_CHOICE_RESPONSE                                   = 0x32B4 + 0x8,
    CMSG_CLOSE_QUEST_CHOICE                                = 0x32B5 + 0x8,
    CMSG_HIDE_QUEST_CHOICE                                 = 0x32B6 + 0x8,
    CMSG_REQUEST_LFG_LIST_BLACKLIST                        = 0x32B7 + 0x8,
    CMSG_SAVE_GUILD_EMBLEM                                 = 0x32BB + 0x8,
    CMSG_TABARD_VENDOR_ACTIVATE                            = 0x32BC + 0x8,
    CMSG_TOGGLE_PVP                                        = 0x32BE + 0x8,
    CMSG_SET_PVP                                           = 0x32BF + 0x8,
    CMSG_SET_WAR_MODE                                      = 0x32C0 + 0x8,
    CMSG_BATTLEMASTER_HELLO                                = 0x32C5 + 0x8,
    CMSG_REQUEST_CONQUEST_FORMULA_CONSTANTS                = 0x32C8 + 0x8,
    CMSG_SET_ADVANCED_COMBAT_LOGGING                       = 0x32C9 + 0x8,
    CMSG_UPGRADE_GARRISON                                  = 0x32D1 + 0x1,
    CMSG_GET_GARRISON_INFO                                 = 0x32D6 + 0x1,
    CMSG_GARRISON_REQUEST_BLUEPRINT_AND_SPECIALIZATION_DATA= 0x32DB + 0x1,
    CMSG_GARRISON_PURCHASE_BUILDING                        = 0x32DC + 0x1,
    CMSG_GARRISON_SET_BUILDING_ACTIVE                      = 0x32DD + 0x1,
    CMSG_GARRISON_CANCEL_CONSTRUCTION                      = 0x32E0 + 0x1,
    CMSG_GARRISON_SWAP_BUILDINGS                           = 0x32E1 + 0x1,
    CMSG_GARRISON_SET_FOLLOWER_INACTIVE                    = 0x32E9 + 0x1,
    CMSG_GARRISON_SET_FOLLOWER_FAVORITE                    = 0x32F1 + 0x1,
    CMSG_GARRISON_ASSIGN_FOLLOWER_TO_BUILDING              = 0x32F3 + 0x1,
    CMSG_GARRISON_REMOVE_FOLLOWER_FROM_BUILDING            = 0x32F4 + 0x1,
    CMSG_GARRISON_RENAME_FOLLOWER                          = 0x32F5 + 0x1,
    CMSG_GARRISON_GENERATE_RECRUITS                        = 0x32F6 + 0x1,
    CMSG_GARRISON_SET_RECRUITMENT_PREFERENCES              = 0x32F7 + 0x1,
    CMSG_GARRISON_RECRUIT_FOLLOWER                         = 0x32F8 + 0x1,
    CMSG_GARRISON_RESEARCH_TALENT                          = 0x32F9 + 0x1,
    CMSG_GARRISON_LEARN_TALENT                             = 0x3301 + 0x1,
    CMSG_GARRISON_GET_CLASS_SPEC_CATEGORY_INFO             = 0x3305 + 0x1,
    CMSG_OPEN_MISSION_NPC                                  = 0x3307 + 0x1,
    CMSG_SET_USING_PARTY_GARRISON                          = 0x3309 + 0x1,
    CMSG_GARRISON_GET_MAP_DATA                             = 0x330C + 0x1,
    CMSG_GARRISON_ADD_FOLLOWER_HEALTH                      = 0x330D + 0x1,
    CMSG_GARRISON_FULLY_HEAL_ALL_FOLLOWERS                 = 0x330E + 0x1,
    CMSG_OPEN_SHIPMENT_NPC                                 = 0x330F + 0x1,
    CMSG_GARRISON_REQUEST_SHIPMENT_INFO                    = 0x3310 + 0x1,
    CMSG_GET_LANDING_PAGE_SHIPMENTS                        = 0x3311 + 0x1,
    CMSG_CREATE_SHIPMENT                                   = 0x3312 + 0x1,
    CMSG_OPEN_TRADESKILL_NPC                               = 0x331A + 0x1,
    CMSG_GET_TROPHY_LIST                                   = 0x3323 + 0x1,
    CMSG_LOAD_SELECTED_TROPHY                              = 0x3324 + 0x1,
    CMSG_REPLACE_TROPHY                                    = 0x3325 + 0x1,
    CMSG_CHANGE_MONUMENT_APPEARANCE                        = 0x3326 + 0x1,
    CMSG_REVERT_MONUMENT_APPEARANCE                        = 0x3327 + 0x1,
    CMSG_GARRISON_REMOVE_FOLLOWER                          = 0x332A + 0x1,
    CMSG_GARRISON_START_MISSION                            = 0x3332 + 0x1,
    CMSG_GARRISON_COMPLETE_MISSION                         = 0x3333 + 0x1,
    CMSG_GARRISON_MISSION_BONUS_ROLL                       = 0x3335 + 0x1,
    CMSG_GARRISON_CHECK_UPGRADEABLE                        = 0x3341 + 0x1,
    CMSG_ITEM_TEXT_QUERY                                   = 0x3342 + 0x1,
    CMSG_OPEN_ITEM                                         = 0x3343 + 0x1,
    CMSG_READ_ITEM                                         = 0x3344 + 0x1,
    CMSG_CHANGE_BAG_SLOT_FLAG                              = 0x3345 + 0x1,
    CMSG_CHANGE_BANK_BAG_SLOT_FLAG                         = 0x3346 + 0x1,
    CMSG_SET_BACKPACK_AUTOSORT_DISABLED                    = 0x3347 + 0x1,
    CMSG_SET_BANK_AUTOSORT_DISABLED                        = 0x3348 + 0x1,
    CMSG_SET_SORT_BAGS_RIGHT_TO_LEFT                       = 0x3349 + 0x1,
    CMSG_SET_INSERT_ITEMS_LEFT_TO_RIGHT                    = 0x334A + 0x1,
    CMSG_SORT_BAGS                                         = 0x334B + 0x1,
    CMSG_SORT_BANK_BAGS                                    = 0x334C + 0x1,
    CMSG_SORT_REAGENT_BANK_BAGS                            = 0x334D + 0x1,
    CMSG_DEPOSIT_REAGENT_BANK                              = 0x334E + 0x1,
    CMSG_ADVENTURE_MAP_START_QUEST                         = 0x3360 + 0x1,
    CMSG_GARRISON_GET_MISSION_REWARD                       = 0x3364 + 0x1,
    CMSG_TRADE_SKILL_SET_FAVORITE                          = 0x3366 + 0x1,
    CMSG_QUERY_TREASURE_PICKER                             = 0x3367 + 0x1,
    CMSG_REQUEST_WORLD_QUEST_UPDATE                        = 0x3368 + 0x1,
    CMSG_REQUEST_AREA_POI_UPDATE                           = 0x3369 + 0x1,
    CMSG_REMOVE_NEW_ITEM                                   = 0x336A + 0x1,
    CMSG_AZERITE_EMPOWERED_ITEM_VIEWED                     = 0x336B + 0x1,
    CMSG_LFG_LIST_JOIN                                     = 0x3386 + 0x1,
    CMSG_LFG_LIST_UPDATE_REQUEST                           = 0x3387 + 0x1,
    CMSG_AZERITE_EMPOWERED_ITEM_SELECT_POWER               = 0x3388 + 0x1,
    CMSG_AZERITE_ESSENCE_UNLOCK_MILESTONE                  = 0x3389 + 0x1,
    CMSG_AZERITE_ESSENCE_ACTIVATE_ESSENCE                  = 0x338A + 0x1,
    CMSG_BONUS_ROLL                                        = 0x338B + 0x1,
    CMSG_ISLAND_QUEUE                                      = 0x33A7 + 0x1,
    CMSG_UI_MAP_QUEST_LINES_REQUEST                        = 0x33A8 + 0x1,
    CMSG_REQUEST_COVENANT_CALLINGS                         = 0x33A9 + 0x1,
    CMSG_CLAIM_WEEKLY_REWARD                               = 0x33AB + 0x1,
    CMSG_REQUEST_WEEKLY_REWARDS                            = 0x33AC + 0x1,
    CMSG_REPORT_SERVER_LAG                                 = 0x33B7 + 0x1,
    CMSG_REPORT_STUCK_IN_COMBAT                            = 0x33B8 + 0x1,
    CMSG_REQUEST_LATEST_SPLASH_SCREEN                      = 0x33B9 + 0x1,
    CMSG_QUEST_SESSION_REQUEST_START                       = 0x33BE + 0x1,
    CMSG_QUEST_SESSION_BEGIN_RESPONSE                      = 0x33BF + 0x1,
    CMSG_OFFER_PETITION                                    = 0x33CE + 0x1,
    CMSG_CHROMIE_TIME_SELECT_EXPANSION                     = 0x33CF + 0x1,
    CMSG_ACTIVATE_SOULBIND                                 = 0x33D0 + 0x1,
    CMSG_ADVENTURE_JOURNAL_UPDATE_SUGGESTIONS              = 0x33D3 + 0x1,
    CMSG_UPGRADE_RUNEFORGE_LEGENDARY                       = 0x33D6 + 0x1,
    CMSG_CLOSE_RUNEFORGE_INTERACTION                       = 0x33D7 + 0x1,
    CMSG_SUBSCRIPTION_INTERSTITIAL_RESPONSE                = 0x33D8 + 0x1,
    ...
    CMSG_RAF_CLAIM_ACTIVITY_REWARD                         = 0x3512 + 0x1,
    CMSG_HEARTH_AND_RESURRECT                              = 0x3515 + 0x1,
    CMSG_SAVE_EQUIPMENT_SET                                = 0x3518 + 0x1,
    CMSG_DELETE_EQUIPMENT_SET                              = 0x3519 + 0x1,
    CMSG_INSTANCE_LOCK_RESPONSE                            = 0x351A + 0x1,
    CMSG_LOW_LEVEL_RAID2                                   = 0x3521 + 0x1,
    CMSG_DECLINE_GUILD_INVITES                             = 0x352D + 0x1,
    CMSG_OVERRIDE_SCREEN_FLASH                             = 0x352E + 0x1,
    CMSG_BATTLEMASTER_JOIN                                 = 0x3530 + 0x1,
    CMSG_BATTLEMASTER_JOIN_ARENA                           = 0x3531 + 0x1,
    CMSG_BATTLEMASTER_JOIN_SKIRMISH                        = 0x3532 + 0x1,
    CMSG_BATTLEMASTER_JOIN_BRAWL                           = 0x3535 + 0x1,
    CMSG_BATTLEFIELD_PORT                                  = 0x3537 + 0x1,
    CMSG_REPOP_REQUEST                                     = 0x3538 + 0x1,
    CMSG_CLIENT_PORT_GRAVEYARD                             = 0x3539 + 0x1,
    CMSG_SET_SELECTION                                     = 0x353A + 0x1,
    CMSG_INSPECT                                           = 0x353B + 0x1,
    CMSG_REQUEST_CROWD_CONTROL_SPELL                       = 0x353C + 0x1,
    CMSG_BLACK_MARKET_OPEN                                 = 0x353D + 0x1,
    CMSG_BLACK_MARKET_REQUEST_ITEMS                        = 0x353E + 0x1,
    CMSG_BLACK_MARKET_BID_ON_ITEM                          = 0x353F + 0x1,
    CMSG_QUEST_LOG_REMOVE_QUEST                            = 0x3540 + 0x1,
    CMSG_GET_ITEM_PURCHASE_DATA                            = 0x3541 + 0x1,
    CMSG_ITEM_PURCHASE_REFUND                              = 0x3542 + 0x1,
    CMSG_SELF_RES                                          = 0x3543 + 0x1,
    CMSG_SET_ACTION_BAR_TOGGLES                            = 0x3544 + 0x1,
    CMSG_SIGN_PETITION                                     = 0x3545 + 0x1,
    CMSG_DECLINE_PETITION                                  = 0x3546 + 0x1,
    CMSG_TURN_IN_PETITION                                  = 0x3547 + 0x1,
    CMSG_MAIL_GET_LIST                                     = 0x3548 + 0x1,
    CMSG_MAIL_TAKE_MONEY                                   = 0x3549 + 0x1,
    CMSG_MAIL_TAKE_ITEM                                    = 0x354A + 0x1,
    CMSG_QUERY_NEXT_MAIL_TIME                              = 0x354B + 0x1,
    CMSG_MAIL_MARK_AS_READ                                 = 0x354C + 0x1,
    CMSG_MAIL_CREATE_TEXT_ITEM                             = 0x354D + 0x1,
    CMSG_SET_LOOT_SPECIALIZATION                           = 0x3551 + 0x1,
    CMSG_EMOTE                                             = 0x3553 + 0x1,
    CMSG_OPENING_CINEMATIC                                 = 0x3555 + 0x1,
    CMSG_NEXT_CINEMATIC_CAMERA                             = 0x3556 + 0x1,
    CMSG_COMPLETE_CINEMATIC                                = 0x3557 + 0x1,
    CMSG_CONVERSATION_LINE_STARTED                         = 0x3558 + 0x1,
    CMSG_CONVERSATION_CINEMATIC_READY                      = 0x3559 + 0x1,
    CMSG_QUEST_GIVER_CLOSE_QUEST                           = 0x355C + 0x1,
    CMSG_START_CHALLENGE_MODE                              = 0x355D + 0x1,
    CMSG_LEARN_TALENTS                                     = 0x3568 + 0x1,
    CMSG_LEARN_PVP_TALENTS                                 = 0x356A + 0x1,
    CMSG_CONTRIBUTION_CONTRIBUTE                           = 0x356B + 0x1,
    CMSG_CONTRIBUTION_LAST_UPDATE_REQUEST                  = 0x356C + 0x1,
    CMSG_GOSSIP_REFRESH_OPTIONS                            = 0x357E + 0x1,
    CMSG_COVENANT_RENOWN_REQUEST_CATCHUP_STATE             = 0x357F + 0x1,
    ...
    CMSG_CREATE_CHARACTER                                  = 0x3643 + 0x1,
    CMSG_CHECK_CHARACTER_NAME_AVAILABILITY                 = 0x3644 + 0x1,
    CMSG_SUPPORT_TICKET_SUBMIT_COMPLAINT                   = 0x3645 + 0x1,
    CMSG_PARTY_UNINVITE                                    = 0x3646 + 0x1,
    CMSG_SET_LOOT_METHOD                                   = 0x3647 + 0x1,
    CMSG_LEAVE_GROUP                                       = 0x3648 + 0x1,
    CMSG_SET_PARTY_LEADER                                  = 0x3649 + 0x1,
    CMSG_MINIMAP_PING                                      = 0x364A + 0x1,
    CMSG_CHANGE_SUB_GROUP                                  = 0x364B + 0x1,
    CMSG_SWAP_SUB_GROUPS                                   = 0x364C + 0x1,
    CMSG_CONVERT_RAID                                      = 0x364D + 0x1,
    CMSG_SET_ASSISTANT_LEADER                              = 0x364E + 0x1,
    CMSG_UPDATE_RAID_TARGET                                = 0x364F + 0x1,
    CMSG_SET_PARTY_ASSIGNMENT                              = 0x3650 + 0x1,
    CMSG_SILENCE_PARTY_TALKER                              = 0x3651 + 0x1,
    CMSG_REQUEST_PARTY_MEMBER_STATS                        = 0x3652 + 0x1,
    CMSG_RANDOM_ROLL                                       = 0x3653 + 0x1,
    CMSG_MAIL_RETURN_TO_SENDER                             = 0x3654 + 0x1,
    CMSG_QUERY_SCENARIO_POI                                = 0x3655 + 0x1,
    CMSG_TOGGLE_DIFFICULTY                                 = 0x3656 + 0x1,
    CMSG_ADD_BATTLENET_FRIEND                              = 0x3659 + 0x1,
    CMSG_QUERY_CORPSE_LOCATION_FROM_CLIENT                 = 0x365F + 0x1,
    CMSG_QUERY_CORPSE_TRANSPORT                            = 0x3660 + 0x1,
    CMSG_CAN_DUEL                                          = 0x3661 + 0x1,
    CMSG_UPDATE_CLIENT_SETTINGS                            = 0x3663 + 0x1,
    CMSG_RESET_INSTANCES                                   = 0x3667 + 0x1,
    CMSG_SUMMON_RESPONSE                                   = 0x3669 + 0x1,
    CMSG_COMPLAINT                                         = 0x366B + 0x1,
    CMSG_CALENDAR_GET                                      = 0x366E + 0x1,
    CMSG_CALENDAR_GET_EVENT                                = 0x366F + 0x1,
    CMSG_CALENDAR_COMMUNITY_INVITE                         = 0x3670 + 0x1,
    CMSG_CALENDAR_INVITE                                   = 0x3671 + 0x1,
    CMSG_CALENDAR_REMOVE_INVITE                            = 0x3672 + 0x1,
    CMSG_CALENDAR_RSVP                                     = 0x3673 + 0x1,
    CMSG_CALENDAR_STATUS                                   = 0x3674 + 0x1,
    CMSG_CALENDAR_MODERATOR_STATUS                         = 0x3675 + 0x1,
    CMSG_CALENDAR_REMOVE_EVENT                             = 0x3676 + 0x1,
    CMSG_CALENDAR_COPY_EVENT                               = 0x3677 + 0x1,
    CMSG_CALENDAR_COMPLAIN                                 = 0x3678 + 0x1,
    CMSG_CALENDAR_GET_NUM_PENDING                          = 0x3679 + 0x1,
    CMSG_CALENDAR_EVENT_SIGN_UP                            = 0x367A + 0x1,
    CMSG_CALENDAR_ADD_EVENT                                = 0x367C + 0x1,
    CMSG_CALENDAR_UPDATE_EVENT                             = 0x367D + 0x1,
    CMSG_KEEP_ALIVE                                        = 0x367E + 0x1,
    CMSG_WHO_IS                                            = 0x367F + 0x1,
    CMSG_WHO                                               = 0x3680 + 0x1,
    CMSG_SET_DUNGEON_DIFFICULTY                            = 0x3681 + 0x1,
    CMSG_RESURRECT_RESPONSE                                = 0x3682 + 0x1,
    CMSG_PET_RENAME                                        = 0x3683 + 0x1,
    CMSG_BUG_REPORT                                        = 0x3684 + 0x1,
    CMSG_SET_SAVED_INSTANCE_EXTEND                         = 0x3685 + 0x1,
    CMSG_SET_PLAYER_DECLINED_NAMES                         = 0x3687 + 0x1,
    CMSG_QUERY_REALM_NAME                                  = 0x3688 + 0x1,
    CMSG_QUERY_GUILD_INFO                                  = 0x3689 + 0x1,
    CMSG_REQUEST_CHARACTER_GUILD_FOLLOW_INFO               = 0x368A + 0x1,
    CMSG_CHAR_CUSTOMIZE                                    = 0x368B + 0x1,
    CMSG_GM_TICKET_GET_SYSTEM_STATUS                       = 0x368D + 0x1,
    CMSG_GM_TICKET_GET_CASE_STATUS                         = 0x368E + 0x1,
    CMSG_GM_TICKET_ACKNOWLEDGE_SURVEY                      = 0x368F + 0x1,
    CMSG_CHAR_RACE_OR_FACTION_CHANGE                       = 0x3691 + 0x1,
    CMSG_SUBMIT_USER_FEEDBACK                              = 0x3692 + 0x1,
    CMSG_REQUEST_ACCOUNT_DATA                              = 0x3693 + 0x1,
    CMSG_UPDATE_ACCOUNT_DATA                               = 0x3694 + 0x1,
    CMSG_SERVER_TIME_OFFSET_REQUEST                        = 0x3699 + 0x1,
    CMSG_CHAR_DELETE                                       = 0x369A + 0x1,
    CMSG_LOW_LEVEL_RAID1                                   = 0x369E + 0x1,
    CMSG_QUEST_POI_QUERY                                   = 0x36AC + 0x1,
    CMSG_GET_ACCOUNT_CHARACTER_LIST                        = 0x36B2 + 0x1,
    CMSG_LIVE_REGION_GET_ACCOUNT_CHARACTER_LIST            = 0x36B3 + 0x1,
    CMSG_LIVE_REGION_CHARACTER_COPY                        = 0x36B4 + 0x1,
    CMSG_LIVE_REGION_ACCOUNT_RESTORE                       = 0x36B5 + 0x1,
    CMSG_LIVE_REGION_KEY_BINDINGS_COPY                     = 0x36B6 + 0x1,
    CMSG_BATTLE_PAY_GET_PRODUCT_LIST                       = 0x36B7 + 0x1,
    CMSG_BATTLE_PAY_GET_PURCHASE_LIST                      = 0x36B8 + 0x1,
    CMSG_CHARACTER_RENAME_REQUEST                          = 0x36BD + 0x1,
    CMSG_SHOW_TRADE_SKILL                                  = 0x36BE + 0x1,
    CMSG_BATTLE_PAY_DISTRIBUTION_ASSIGN_TO_TARGET          = 0x36BF + 0x1,
    CMSG_CHARACTER_UPGRADE_MANUAL_UNREVOKE_REQUEST         = 0x36C0 + 0x1,
    CMSG_CHARACTER_UPGRADE_START                           = 0x36C1 + 0x1,
    CMSG_CHARACTER_CHECK_UPGRADE                           = 0x36C2 + 0x1,
    CMSG_GUILD_SET_GUILD_MASTER                            = 0x36C4 + 0x1,
    CMSG_PETITION_RENAME_GUILD                             = 0x36C5 + 0x1,
    CMSG_REQUEST_RAID_INFO                                 = 0x36C6 + 0x1,
    CMSG_BATTLE_PAY_START_PURCHASE                         = 0x36C7 + 0x1,
    CMSG_BATTLE_PAY_CONFIRM_PURCHASE_RESPONSE              = 0x36C8 + 0x1,
    CMSG_BATTLE_PAY_ACK_FAILED_RESPONSE                    = 0x36C9 + 0x1,
    CMSG_SEND_CONTACT_LIST                                 = 0x36CB + 0x1,
    CMSG_ADD_FRIEND                                        = 0x36CC + 0x1,
    CMSG_DEL_FRIEND                                        = 0x36CD + 0x1,
    CMSG_SET_CONTACT_NOTES                                 = 0x36CE + 0x1,
    CMSG_BATTLENET_CHALLENGE_RESPONSE                      = 0x36CF + 0x1,
    CMSG_ADD_IGNORE                                        = 0x36D0 + 0x1,
    CMSG_DEL_IGNORE                                        = 0x36D1 + 0x1,
    CMSG_SET_RAID_DIFFICULTY                               = 0x36D7 + 0x1,
    CMSG_TUTORIAL                                          = 0x36D8 + 0x1,
    CMSG_ENUM_CHARACTERS_DELETED_BY_CLIENT                 = 0x36D9 + 0x1,
    CMSG_UNDELETE_CHARACTER                                = 0x36DA + 0x1,
    CMSG_GET_UNDELETE_CHARACTER_COOLDOWN_STATUS            = 0x36DB + 0x1,
    CMSG_ENGINE_SURVEY                                     = 0x36DF + 0x1,
    CMSG_COMMERCE_TOKEN_GET_COUNT                          = 0x36E0 + 0x1,
    CMSG_COMMERCE_TOKEN_GET_MARKET_PRICE                   = 0x36E1 + 0x1,
    CMSG_AUCTIONABLE_TOKEN_SELL                            = 0x36E2 + 0x1,
    CMSG_AUCTIONABLE_TOKEN_SELL_AT_MARKET_PRICE            = 0x36E3 + 0x1,
    CMSG_CONSUMABLE_TOKEN_CAN_VETERAN_BUY                  = 0x36E4 + 0x1,
    CMSG_CONSUMABLE_TOKEN_BUY                              = 0x36E5 + 0x1,
    CMSG_CONSUMABLE_TOKEN_BUY_AT_MARKET_PRICE              = 0x36E6 + 0x1,
    CMSG_GET_REMAINING_GAME_TIME                           = 0x36E7 + 0x1,
    CMSG_CONSUMABLE_TOKEN_REDEEM                           = 0x36E8 + 0x1,
    CMSG_CONSUMABLE_TOKEN_REDEEM_CONFIRMATION              = 0x36E9 + 0x1,
    CMSG_COMMERCE_TOKEN_GET_LOG                            = 0x36EA + 0x1,
    CMSG_GET_VAS_ACCOUNT_CHARACTER_LIST                    = 0x36EC + 0x1,
    CMSG_GET_VAS_TRANSFER_TARGET_REALM_LIST                = 0x36ED + 0x1,
    CMSG_BATTLE_PAY_START_VAS_PURCHASE                     = 0x36EE + 0x1,
    CMSG_UPDATE_VAS_PURCHASE_STATES                        = 0x36EF + 0x1,
    CMSG_BATTLENET_REQUEST                                 = 0x36F1 + 0x1,
    CMSG_CLUB_PRESENCE_SUBSCRIBE                           = 0x36F3 + 0x1,
    CMSG_SEND_CHARACTER_CLUB_INVITATION                    = 0x36F5 + 0x1,
    CMSG_CHANGE_REALM_TICKET                               = 0x36F6 + 0x1,
    CMSG_REPORT_ENABLED_ADDONS                             = 0x36FB + 0x1,
    CMSG_REPORT_CLIENT_VARIABLES                           = 0x36FC + 0x1,
    CMSG_REPORT_KEYBINDING_EXECUTION_COUNTS                = 0x36FD + 0x1,
    CMSG_QUICK_JOIN_SIGNAL_TOAST_DISPLAYED                 = 0x36FF + 0x1,
    CMSG_QUICK_JOIN_RESPOND_TO_INVITE                      = 0x3700 + 0x1,
    CMSG_QUICK_JOIN_REQUEST_INVITE                         = 0x3701 + 0x1,
    CMSG_QUICK_JOIN_AUTO_ACCEPT_REQUESTS                   = 0x3702 + 0x1,
    CMSG_CAN_REDEEM_TOKEN_FOR_BALANCE                      = 0x3703 + 0x1,
    CMSG_BATTLE_PAY_REQUEST_PRICE_INFO                     = 0x3704 + 0x1,
    CMSG_VAS_GET_SERVICE_STATUS                            = 0x3705 + 0x1,
    CMSG_VAS_GET_QUEUE_MINUTES                             = 0x3706 + 0x1,
    CMSG_VAS_CHECK_TRANSFER_OK                             = 0x3707 + 0x1,
    CMSG_BATTLE_PAY_OPEN_CHECKOUT                          = 0x3708 + 0x1,
    CMSG_VOICE_CHAT_LOGIN                                  = 0x370A + 0x1,
    CMSG_VOICE_CHANNEL_STT_TOKEN_REQUEST                   = 0x370B + 0x1,
    CMSG_VOICE_CHAT_JOIN_CHANNEL                           = 0x370C + 0x1,
    CMSG_BATTLE_PAY_CANCEL_OPEN_CHECKOUT                   = 0x370F + 0x1,
    CMSG_DO_COUNTDOWN                                      = 0x3714 + 0x1,
    CMSG_CLUB_FINDER_POST                                  = 0x3715 + 0x1,
    CMSG_CLUB_FINDER_REQUEST_CLUBS_LIST                    = 0x3716 + 0x1,
    CMSG_CLUB_FINDER_REQUEST_MEMBERSHIP_TO_CLUB            = 0x3717 + 0x1,
    CMSG_CLUB_FINDER_GET_APPLICANTS_LIST                   = 0x3718 + 0x1,
    CMSG_CLUB_FINDER_RESPOND_TO_APPLICANT                  = 0x3719 + 0x1,
    CMSG_CLUB_FINDER_APPLICATION_RESPONSE                  = 0x371A + 0x1,
    CMSG_CLUB_FINDER_REQUEST_PENDING_CLUBS_LIST            = 0x371B + 0x1,
    CMSG_CLUB_FINDER_REQUEST_CLUBS_DATA                    = 0x371C + 0x1,
    CMSG_CLUB_FINDER_REQUEST_SUBSCRIBED_CLUB_POSTING_IDS   = 0x371D + 0x1,
    CMSG_GET_RAF_ACCOUNT_INFO                              = 0x371E + 0x1,
    CMSG_RAF_CLAIM_NEXT_REWARD                             = 0x371F + 0x1,
    CMSG_RAF_UPDATE_RECRUITMENT_INFO                       = 0x3720 + 0x1,
    CMSG_RAF_GENERATE_RECRUITMENT_LINK                     = 0x3721 + 0x1,
    CMSG_REMOVE_RAF_RECRUIT                                = 0x3722 + 0x1,
    CMSG_QUEST_SESSION_REQUEST_STOP                        = 0x3729 + 0x1,
    CMSG_QUICK_JOIN_REQUEST_INVITE_WITH_CONFIRMATION       = 0x372E + 0x1,
    CMSG_GET_ACCOUNT_NOTIFICATIONS                         = 0x3730 + 0x1,
    CMSG_ACCOUNT_NOTIFICATION_ACKNOWLEDGED                 = 0x3731 + 0x1,
    CMSG_AUCTION_SET_FAVORITE_ITEM                         = 0x3732 + 0x1,
    CMSG_AUCTION_REQUEST_FAVORITE_LIST                     = 0x3733 + 0x1,
    CMSG_SET_CHAT_DISABLED                                 = 0x3735 + 0x1,
    CMSG_BATTLE_PAY_DISTRIBUTION_ASSIGN_VAS                = 0x3736 + 0x1,
    CMSG_COMMENTATOR_SPECTATE                              = 0x3737 + 0x1,
    CMSG_CLUB_FINDER_WHISPER_APPLICANT_REQUEST             = 0x3739 + 0x1,
    CMSG_SOCIAL_CONTRACT_REQUEST                           = 0x373A + 0x1,
    CMSG_ACCEPT_SOCIAL_CONTRACT                            = 0x373B + 0x1,
    ...
    CMSG_SET_ACTIVE_MOVER                                  = 0x3A3D, ///< UNK
...
enum OpcodeServer : uint16
{
    ...
    SMSG_ACCOUNT_HEIRLOOM_UPDATE                                  = 0x25B0,
    ...
    SMSG_UPDATE_TALENT_DATA                                       = 0x25D4,
    SMSG_UPDATE_PRIMARY_SPEC                                      = 0x25D5,
    SMSG_SHOW_NEUTRAL_PLAYER_FACTION_SELECT_UI                    = 0x25D8,
    SMSG_NEUTRAL_PLAYER_FACTION_SELECT_RESULT                     = 0x25D9,
    SMSG_SET_CHR_UPGRADE_TIER                                     = 0x25DC,
    SMSG_UPDATE_ACTION_BUTTONS                                    = 0x25DD,
    SMSG_DONT_AUTO_PUSH_SPELLS_TO_ACTION_BAR                      = 0x25DE,
    SMSG_SCENE_OBJECT_EVENT                                       = 0x25DF,
    SMSG_SCENE_OBJECT_PET_BATTLE_INITIAL_UPDATE                   = 0x25E0,
    SMSG_SCENE_OBJECT_PET_BATTLE_FIRST_ROUND                      = 0x25E1,
    SMSG_SCENE_OBJECT_PET_BATTLE_ROUND_RESULT                     = 0x25E2,
    SMSG_SCENE_OBJECT_PET_BATTLE_REPLACEMENTS_MADE                = 0x25E3,
    SMSG_SCENE_OBJECT_PET_BATTLE_FINAL_ROUND                      = 0x25E4,
    SMSG_SCENE_OBJECT_PET_BATTLE_FINISHED                         = 0x25E5,
    SMSG_BATTLE_PET_UPDATES                                       = 0x25E7,
    SMSG_BATTLE_PET_TRAP_LEVEL                                    = 0x25E8,
    ...
    SMSG_TOTEM_DURATION_CHANGED                                   = 0x26C3,
    SMSG_TOTEM_MOVED                                              = 0x26C4,
    SMSG_TRIGGER_MOVIE                                            = 0x26C5,
    SMSG_SHOW_TAXI_NODES                                          = 0x26C7,
    SMSG_MINIMAP_PING                                             = 0x26C8,
    SMSG_FISH_NOT_HOOKED                                          = 0x26C9,
    SMSG_FISH_ESCAPED                                             = 0x26CA,
    SMSG_HEALTH_UPDATE                                            = 0x26CB,
    SMSG_POWER_UPDATE                                             = 0x26CC,
    SMSG_DEATH_RELEASE_LOC                                        = 0x26CD,
    SMSG_FORCED_DEATH_UPDATE                                      = 0x26CE,
    SMSG_PLAYED_TIME                                              = 0x26CF,
    SMSG_TITLE_EARNED                                             = 0x26D1,
    SMSG_TITLE_LOST                                               = 0x26D2,
    SMSG_HIGHEST_THREAT_UPDATE                                    = 0x26D3,
    SMSG_THREAT_UPDATE                                            = 0x26D4,
    SMSG_THREAT_REMOVE                                            = 0x26D5,
    SMSG_THREAT_CLEAR                                             = 0x26D6,
    SMSG_CANCEL_AUTO_REPEAT                                       = 0x26D7,
    SMSG_TRAINER_LIST                                             = 0x26D8,
    SMSG_TRAINER_BUY_FAILED                                       = 0x26D9,
    SMSG_CRITERIA_UPDATE                                          = 0x26DA,
    SMSG_CHAR_CUSTOMIZE_FAILURE                                   = 0x26DB,
    SMSG_CHAR_CUSTOMIZE_SUCCESS                                   = 0x26DC,
    SMSG_QUERY_TIME_RESPONSE                                      = 0x26DD,
    SMSG_LOG_XP_GAIN                                              = 0x26DE,
    ...
    SMSG_OPEN_SHIPMENT_NPC_FROM_GOSSIP                            = 0x2790,
    ...
    SMSG_OPEN_ITEM_FORGE                                          = 0x2798,
    SMSG_CLOSE_ITEM_FORGE                                         = 0x2799,
    ...
    SMSG_REPLACE_TROPHY_RESPONSE                                  = 0x27BB,
    SMSG_GET_TROPHY_LIST_RESPONSE                                 = 0x27BC,
    SMSG_GET_SELECTED_TROPHY_ID_RESPONSE                          = 0x27BD,
    ...
    SMSG_ADVENTURE_MAP_OPEN_NPC                                   = 0x27ED,
    SMSG_WORLD_MAP_OPEN_NPC                                       = 0x27EE,
    ...
    SMSG_COVENANT_RENOWN_OPEN_NPC                                 = 0x2872,
    ...
    SMSG_PVP_TIER_RECORD                                          = 0x2882,
    SMSG_UPDATE_AADC_STATUS_RESPONSE                              = 0x2883,
    SMSG_BATTLE_PAY_DISTRIBUTION_ASSIGN_VAS_RESPONSE              = 0x2885,
    SMSG_SHADOWLANDS_CAPACITANCE_UPDATE                           = 0x2886,
    SMSG_CLUB_FINDER_WHISPER_APPLICANT_RESPONSE                   = 0x2888,
    SMSG_MEETING_STONE_FAILED                                     = 0x288A,
    SMSG_SOCIAL_CONTRACT_REQUEST_RESPONSE                         = 0x288B,
    SMSG_AUCTION_DISABLE_POSTING_BEFORE_MAINTENANCE               = 0x288D,
