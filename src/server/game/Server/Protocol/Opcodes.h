...
enum OpcodeServer : uint16
{
    ...
    SMSG_COVENANT_RENOWN_OPEN_NPC                                 = 0x2873,
    ...
    SMSG_PVP_TIER_RECORD                                          = 0x2883,
    SMSG_UPDATE_AADC_STATUS_RESPONSE                              = 0x2884,
    SMSG_BATTLE_PAY_DISTRIBUTION_ASSIGN_VAS_RESPONSE              = 0x2886,
    ...
    SMSG_AUCTION_DISABLE_POSTING_BEFORE_MAINTENANCE               = 0x288E,
