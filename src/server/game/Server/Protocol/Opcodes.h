...
enum OpcodeClient : uint16
{
    ...
    CMSG_BATTLE_PAY_GET_PURCHASE_LIST                 = 0x3772,
    ...
    CMSG_CAN_REDEEM_TOKEN_FOR_BALANCE                 = 0x0000,
    ...
    CMSG_CONSUMABLE_TOKEN_REDEEM                      = 0x0000,
    CMSG_CONSUMABLE_TOKEN_REDEEM_CONFIRMATION         = 0x0000,
    ...
    CMSG_QUERY_PLAYER_NAMES                           = 0x0000,
    ...
    CMSG_RAF_CLAIM_NEXT_REWARD                        = 0x0000,
    ...
    CMSG_UPDATE_ACCOUNT_DATA                          = 0x3695, ///< DF
