...
enum OpcodeClient : uint16
{
    ...
    CMSG_ASSIGN_EQUIPMENT_SET_SPEC                         = 0x3211 + 0x1,
    CMSG_CONFIRM_RESPEC_WIPE                               = 0x3213 + 0x1,
    CMSG_LOOT_UNIT                                         = 0x3214 + 0x1,
    CMSG_LOOT_MONEY                                        = 0x3215 + 0x1,
    CMSG_LOOT_ITEM                                         = 0x3216 + 0x1,
    CMSG_MASTER_LOOT_ITEM                                  = 0x3217 + 0x1,
    CMSG_DO_MASTER_LOOT_ROLL                               = 0x3218 + 0x1,
    CMSG_CANCEL_MASTER_LOOT_ROLL                           = 0x3219 + 0x1,
    CMSG_LOOT_RELEASE                                      = 0x321A + 0x1,
    CMSG_LOOT_ROLL                                         = 0x321B + 0x1,
    CMSG_SCENE_PLAYBACK_COMPLETE                           = 0x3227 + 0x1,
    CMSG_SCENE_PLAYBACK_CANCELED                           = 0x3228 + 0x1,
    CMSG_SCENE_TRIGGER_EVENT                               = 0x3229 + 0x1,
    CMSG_SET_DIFFICULTY_ID                                 = 0x322A + 0x1,
    CMSG_KEYBOUND_OVERRIDE                                 = 0x322B + 0x1,
    CMSG_PET_BATTLE_QUEUE_PROPOSE_MATCH_RESULT             = 0x322C + 0x1,
    CMSG_MAIL_DELETE                                       = 0x322D + 0x1,
    CMSG_SET_ACHIEVEMENTS_HIDDEN                           = 0x322E + 0x1,
    CMSG_MAKE_CONTITIONAL_APPEARANCE_PERMANENT             = 0x322F + 0x1,
    CMSG_PERFORM_ITEM_INTERACTION                          = 0x3237 + 0x1,
    CMSG_REQUEST_VEHICLE_EXIT                              = 0x3241 + 0x1,
    CMSG_REQUEST_VEHICLE_PREV_SEAT                         = 0x3242 + 0x1,
    CMSG_REQUEST_VEHICLE_NEXT_SEAT                         = 0x3243 + 0x1,
    CMSG_REQUEST_VEHICLE_SWITCH_SEAT                       = 0x3244 + 0x1,
    CMSG_RIDE_VEHICLE_INTERACT                             = 0x3245 + 0x1,
    CMSG_EJECT_PASSENGER                                   = 0x3246 + 0x1,
    CMSG_USE_CRITTER_ITEM                                  = 0x324B + 0x1,
    CMSG_CHECK_IS_ADVENTURE_MAP_POI_VALID                  = 0x3251 + 0x1,
