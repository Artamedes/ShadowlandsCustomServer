...
enum OpcodeServer : uint16
{
    ...
    SMSG_ACCOUNT_HEIRLOOM_UPDATE                                  = 0xBADD,
        SMSG_ADVENTURE_MAP_OPEN_NPC = 0xBADD,
        SMSG_WORLD_MAP_OPEN_NPC = 0xBADD,
        SMSG_TRANSMOGRIFY_NPC = 0xBADD,
        SMSG_AZERITE_RESPEC_NPC = 0xBADD,
        SMSG_UI_ITEM_INTERACTION_NPC = 0xBADD,
        SMSG_ISLANDS_MISSION_NPC = 0xBADD,
        SMSG_BINDER_CONFIRM = 0xBADD,
        SMSG_OPEN_HEART_FORGE = 0xBADD,
        SMSG_OPEN_SHIPMENT_NPC_FROM_GOSSIP = 0xBADD,
        SMSG_GAME_OBJECT_UI_LINK = 0xBADD,
