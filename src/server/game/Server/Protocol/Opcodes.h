...
{
    SMSG_ABORT_NEW_WORLD                              = 0x259C, ///< DF
    SMSG_ACCOUNT_COSMETIC_ADDED                       = 0x2872,
    SMSG_ACCOUNT_CRITERIA_UPDATE                      = 0x2858,
    SMSG_ACCOUNT_DATA_TIMES                           = 0x2704, ///< DF
    SMSG_ACCOUNT_MOUNT_UPDATE                         = 0x25AE, ///< DF
    ...
    SMSG_FEATURE_SYSTEM_STATUS                        = 0x25BD, ///< DF
    SMSG_FEATURE_SYSTEM_STATUS_GLUE_SCREEN            = 0x25BE, ///< DF
    ...
    SMSG_GAME_TIME_SET                                = 0x2706, ///< DF
    SMSG_GAME_TIME_UPDATE                             = 0x2705, ///< DF
    ...
    SMSG_ITEM_EXPIRE_PURCHASE_REFUND                  = 0X25A0, ///< DF
    SMSG_ITEM_INTERACTION_COMPLETE                    = 0x2861,
    SMSG_ITEM_PURCHASE_REFUND_RESULT                  = 0x259E, ///< DF
    ...
    SMSG_LOGIN_VERIFY_WORLD                           = 0x259B, ///< DF
    ...
    SMSG_MEETING_STONE_FAILED                         = 0x288A, ///< DF
    ...
    SMSG_NEW_WORLD                                    = 0x2598, ///< OK DF
    SMSG_PRELOAD_WORLD                                = 0x2599, ///< NEW DF
    SMSG_UNK_WORLD_LOAD                               = 0x259A, ///< NEW DF
    SMSG_NOTIFY_DEST_LOC_SPELL_CAST                   = 0x2C43,
    SMSG_NOTIFY_MISSILE_TRAJECTORY_COLLISION          = 0x26A2,
    SMSG_NOTIFY_MONEY                                 = 0x259D, ///< DF
    ...
    SMSG_SERVER_TIME_OFFSET                           = 0x270E, ///< DF
    ...
    SMSG_SET_ITEM_PURCHASE_DATA                       = 0x259F, ///< DF
    ...
    SMSG_TRIGGER_CINEMATIC                            = 0x27C1, ///< DF
    ...
    SMSG_UPDATE_ACCOUNT_DATA                          = 0x2703, ///< DF
    ...
    SMSG_WORLD_SERVER_INFO                            = 0x25AD, ///< DF
