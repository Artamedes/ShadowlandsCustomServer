...
enum OpcodeClient : uint16
{
    ...
    CMSG_SWAP_TRAIT_LOADOUT                                = 0x3214,
    CMSG_ASSIGN_EQUIPMENT_SET_SPEC                         = 0x3215,
    ...
    CMSG_UPGRADE_GARRISON                                  = 0x32D2,
    CMSG_GET_GARRISON_INFO                                 = 0x32D7,
    CMSG_GARRISON_REQUEST_BLUEPRINT_AND_SPECIALIZATION_DATA= 0x32DC,
    CMSG_GARRISON_PURCHASE_BUILDING                        = 0x32DD,
    CMSG_GARRISON_SET_BUILDING_ACTIVE                      = 0x32DE,
    CMSG_GARRISON_CANCEL_CONSTRUCTION                      = 0x32E1,
    CMSG_GARRISON_SWAP_BUILDINGS                           = 0x32E2,
    CMSG_GARRISON_SET_FOLLOWER_INACTIVE                    = 0x32EA,
    CMSG_GARRISON_SET_FOLLOWER_FAVORITE                    = 0x32F2,
    CMSG_GARRISON_ASSIGN_FOLLOWER_TO_BUILDING              = 0x32F4,
    CMSG_GARRISON_REMOVE_FOLLOWER_FROM_BUILDING            = 0x32F5,
    CMSG_GARRISON_RENAME_FOLLOWER                          = 0x32F6,
    CMSG_GARRISON_GENERATE_RECRUITS                        = 0x32F7,
    CMSG_GARRISON_SET_RECRUITMENT_PREFERENCES              = 0x32F8,
    CMSG_GARRISON_RECRUIT_FOLLOWER                         = 0x32F9,
    CMSG_GARRISON_RESEARCH_TALENT                          = 0x3301,
    CMSG_GARRISON_LEARN_TALENT                             = 0x3309,
    CMSG_GARRISON_GET_CLASS_SPEC_CATEGORY_INFO             = 0x3306,
    CMSG_OPEN_MISSION_NPC                                  = 0x3308,
    CMSG_SET_USING_PARTY_GARRISON                          = 0x330A,
    CMSG_GARRISON_GET_MAP_DATA                             = 0x330D,
    CMSG_GARRISON_ADD_FOLLOWER_HEALTH                      = 0x330E,
    CMSG_GARRISON_FULLY_HEAL_ALL_FOLLOWERS                 = 0x330F,
    CMSG_OPEN_SHIPMENT_NPC                                 = 0x3310,
    CMSG_GARRISON_REQUEST_SHIPMENT_INFO                    = 0x3311,
    CMSG_GET_LANDING_PAGE_SHIPMENTS                        = 0x3312,
    CMSG_CREATE_SHIPMENT                                   = 0x3313,
    CMSG_OPEN_TRADESKILL_NPC                               = 0x331B,
    CMSG_GET_TROPHY_LIST                                   = 0x3324,
    CMSG_LOAD_SELECTED_TROPHY                              = 0x3325,
    CMSG_REPLACE_TROPHY                                    = 0x3326,
    CMSG_CHANGE_MONUMENT_APPEARANCE                        = 0x3327,
    CMSG_REVERT_MONUMENT_APPEARANCE                        = 0x3328,
    CMSG_GARRISON_REMOVE_FOLLOWER                          = 0x332B,
    CMSG_GARRISON_START_MISSION                            = 0x3333,
    CMSG_GARRISON_COMPLETE_MISSION                         = 0x3334,
    CMSG_GARRISON_MISSION_BONUS_ROLL                       = 0x3336,
    CMSG_GARRISON_CHECK_UPGRADEABLE                        = 0x3342,
    CMSG_ITEM_TEXT_QUERY                                   = 0x3343,
    CMSG_OPEN_ITEM                                         = 0x3344,
    CMSG_READ_ITEM                                         = 0x334D,
    CMSG_CHANGE_BAG_SLOT_FLAG                              = 0x3346,
    CMSG_CHANGE_BANK_BAG_SLOT_FLAG                         = 0x3347,
    CMSG_SET_BACKPACK_AUTOSORT_DISABLED                    = 0x3348,
    CMSG_SET_BANK_AUTOSORT_DISABLED                        = 0x3349,
    CMSG_SET_SORT_BAGS_RIGHT_TO_LEFT                       = 0x334A,
    CMSG_SET_INSERT_ITEMS_LEFT_TO_RIGHT                    = 0x334B,
    CMSG_SORT_BAGS                                         = 0x334C,
    CMSG_SORT_BANK_BAGS                                    = 0x3345,
    CMSG_SORT_REAGENT_BANK_BAGS                            = 0x334E,
    CMSG_DEPOSIT_REAGENT_BANK                              = 0x334F,
    ...
    CMSG_AZERITE_EMPOWERED_ITEM_VIEWED                     = 0x336C,
    CMSG_LFG_LIST_JOIN                                     = 0x3387,
    CMSG_LFG_LIST_UPDATE_REQUEST                           = 0x3388,
    CMSG_AZERITE_EMPOWERED_ITEM_SELECT_POWER               = 0x3389,
    CMSG_AZERITE_ESSENCE_UNLOCK_MILESTONE                  = 0x338A,
    CMSG_AZERITE_ESSENCE_ACTIVATE_ESSENCE                  = 0x338B,
    CMSG_BONUS_ROLL                                        = 0x338C,
    CMSG_ISLAND_QUEUE                                      = 0x33A8,
    CMSG_UI_MAP_QUEST_LINES_REQUEST                        = 0x33A9,
    CMSG_REQUEST_COVENANT_CALLINGS                         = 0x33AA,
    CMSG_CLAIM_WEEKLY_REWARD                               = 0x33AC,
    CMSG_REQUEST_WEEKLY_REWARDS                            = 0x33AD,
    CMSG_REPORT_SERVER_LAG                                 = 0x33B8,
    CMSG_REPORT_STUCK_IN_COMBAT                            = 0x33B9,
    CMSG_REQUEST_LATEST_SPLASH_SCREEN                      = 0x33BA,
    CMSG_QUEST_SESSION_REQUEST_START                       = 0x33BF,
    CMSG_QUEST_SESSION_BEGIN_RESPONSE                      = 0x33C0,
    CMSG_OFFER_PETITION                                    = 0x33CF,
    CMSG_CHROMIE_TIME_SELECT_EXPANSION                     = 0x33D0,
    CMSG_ACTIVATE_SOULBIND                                 = 0x33D1,
    CMSG_ADVENTURE_JOURNAL_UPDATE_SUGGESTIONS              = 0x33D4,
    CMSG_UPGRADE_RUNEFORGE_LEGENDARY                       = 0x33D7,
    CMSG_CLOSE_RUNEFORGE_INTERACTION                       = 0x33D8,
    CMSG_SUBSCRIPTION_INTERSTITIAL_RESPONSE                = 0x33D9,
    CMSG_ABANDON_NPE_RESPONSE                              = 0x33E2,
    CMSG_REQUEST_GARRISON_TALENT_WORLD_QUEST_UNLOCKS       = 0x33E4,
    CMSG_GARRISON_SOCKET_TALENT                            = 0x33ED,
    CMSG_LEARN_TRAITS                                      = 0x3400,
    ...
    CMSG_MOVE_CHANGE_TRANSPORT                             = 0x3A32,
...
enum OpcodeServer : uint16
{
    ...
    SMSG_ITEM_CHANGED                                             = 0x26E4, ///< Dupe!
    SMSG_AUCTION_HELLO_RESPONSE                                   = 0x26E7,
    SMSG_AUCTION_REPLICATE_RESPONSE                               = 0x26E8,
    SMSG_AUCTION_COMMAND_RESULT                                   = 0x26E9,
    SMSG_AUCTION_WON_NOTIFICATION                                 = 0x26EA,
    SMSG_AUCTION_OUTBID_NOTIFICATION                              = 0x26EB,
    SMSG_AUCTION_CLOSED_NOTIFICATION                              = 0x26EC,
    SMSG_AUCTION_OWNER_BID_NOTIFICATION                           = 0x26ED,
    SMSG_SET_VEHICLE_REC_ID                                       = 0x26F0,
    SMSG_PENDING_RAID_LOCK                                        = 0x26F1,
    SMSG_DESTRUCTIBLE_BUILDING_DAMAGE                             = 0x26F2,
    SMSG_INSTANCE_GROUP_SIZE_CHANGED                              = 0x26F3,
    SMSG_GOD_MODE                                                 = 0x26F5,
    SMSG_BINDER_CONFIRM                                           = 0x26F6,
    SMSG_PLAY_TIME_WARNING                                        = 0x26F7,
    SMSG_SET_FACTION_AT_WAR                                       = 0x26F9,
    SMSG_CREATE_CHAR                                              = 0x26FA,
    SMSG_DELETE_CHAR                                              = 0x26FB,
    SMSG_TRANSFER_ABORTED                                         = 0x26FC,
    SMSG_PET_GUIDS                                                = 0x26FD,
    SMSG_CHARACTER_LOGIN_FAILED                                   = 0x26FE,
    SMSG_COMMENTATOR_STATE_CHANGED                                = 0x26FF,
    SMSG_COMMENTATOR_MAP_INFO                                     = 0x2700,
    SMSG_COMMENTATOR_PLAYER_INFO                                  = 0x2701,
    SMSG_UPDATE_ACCOUNT_DATA                                      = 0x2702,
    SMSG_ACCOUNT_DATA_TIMES                                       = 0x2703,
    SMSG_GAME_TIME_UPDATE                                         = 0x2704,
    SMSG_GAME_TIME_SET                                            = 0x2705,
    SMSG_LOGIN_SET_TIME_SPEED                                     = 0x2706,
    SMSG_LOAD_EQUIPMENT_SET                                       = 0x2707,
    SMSG_START_MIRROR_TIMER                                       = 0x2708,
    SMSG_PAUSE_MIRROR_TIMER                                       = 0x2709,
    SMSG_STOP_MIRROR_TIMER                                        = 0x270A,
    SMSG_CORPSE_TRANSPORT_QUERY                                   = 0x270B,
    SMSG_ENCHANTMENT_LOG                                          = 0x270C,
    SMSG_SERVER_TIME_OFFSET                                       = 0x270D,
    SMSG_SPIRIT_HEALER_CONFIRM                                    = 0x270E,
    SMSG_AREA_TRIGGER_NO_CORPSE                                   = 0x270F,
    SMSG_TALENTS_INVOLUNTARILY_RESET                              = 0x2710,
    SMSG_SPEC_INVOLUNTARILY_CHANGED                               = 0x2711,
    SMSG_PAGE_TEXT                                                = 0x2712,
    SMSG_GAME_OBJECT_UI_LINK                                      = 0x2713,
    SMSG_OPEN_ANIMA_DIVERSION_UI                                  = 0x2714,
    SMSG_STAND_STATE_UPDATE                                       = 0x2715,
    SMSG_SET_FORCED_REACTIONS                                     = 0x2716,
    SMSG_GAME_OBJECT_RESET_STATE                                  = 0x2717,
    SMSG_SUMMON_REQUEST                                           = 0x271A,
    SMSG_INITIALIZE_FACTIONS                                      = 0x271C,
    SMSG_FACTION_BONUS_INFO                                       = 0x271D,
    SMSG_CAMERA_EFFECT                                            = 0x271E,
    SMSG_SOCKET_GEMS_SUCCESS                                      = 0x271F,
    SMSG_SOCKET_GEMS_FAILURE                                      = 0x2720,
    SMSG_SET_FACTION_VISIBLE                                      = 0x2722,
    SMSG_SET_FACTION_NOT_VISIBLE                                  = 0x2723,
    SMSG_SET_FACTION_STANDING                                     = 0x2724,
    SMSG_SET_AI_ANIM_KIT                                          = 0x2728,
    SMSG_PLAY_ONE_SHOT_ANIM_KIT                                   = 0x2729,
    SMSG_SET_MOVEMENT_ANIM_KIT                                    = 0x272A,
    SMSG_SET_MELEE_ANIM_KIT                                       = 0x272B,
    SMSG_SET_ANIM_TIER                                            = 0x272C,
    SMSG_SET_PROFICIENCY                                          = 0x272D,
    SMSG_COOLDOWN_CHEAT                                           = 0x2731,
    SMSG_AREA_SPIRIT_HEALER_TIME                                  = 0x2738,
    SMSG_LOOT_LIST                                                = 0x2739,
    SMSG_DESTROY_ARENA_UNIT                                       = 0x273A,
    SMSG_UI_HEALING_RANGE_MODIFIED                                = 0x273C,
    SMSG_FEIGN_DEATH_RESISTED                                     = 0x273D,
    SMSG_DURABILITY_DAMAGE_DEATH                                  = 0x273E,
    SMSG_INIT_WORLD_STATES                                        = 0x273F,
    SMSG_UPDATE_WORLD_STATE                                       = 0x2740,
    SMSG_PET_ACTION_FEEDBACK                                      = 0x2741,
    SMSG_CORPSE_RECLAIM_DELAY                                     = 0x2742,
    SMSG_REATTACH_RESURRECT                                       = 0x2743,
    SMSG_PETITION_SIGN_RESULTS                                    = 0x2744,
    SMSG_TURN_IN_PETITION_RESULT                                  = 0x2746,
    SMSG_USE_EQUIPMENT_SET_RESULT                                 = 0x2747,
    SMSG_FORCE_ANIM                                               = 0x2749,
    SMSG_FORCE_ANIMATIONS                                         = 0x274A,
    SMSG_INVALID_PROMOTION_CODE                                   = 0x274B,
    SMSG_ITEM_TIME_UPDATE                                         = 0x274C,
    SMSG_ITEM_ENCHANT_TIME_UPDATE                                 = 0x274D,
    SMSG_MAIL_LIST_RESULT                                         = 0x274E,
    SMSG_MAIL_QUERY_NEXT_TIME_RESULT                              = 0x274F,
    SMSG_PARTY_MEMBER_PARTIAL_STATE                               = 0x2750,
    SMSG_PARTY_MEMBER_FULL_STATE                                  = 0x2751,
    SMSG_PARTY_KILL_LOG                                           = 0x2752,
    SMSG_PROC_RESIST                                              = 0x2753,
    SMSG_ISLAND_AZERITE_GAIN                                      = 0x2754,
    SMSG_ISLAND_COMPLETE                                          = 0x2755,
    SMSG_WARFRONT_COMPLETE                                        = 0x2756,
    SMSG_EXPLORATION_EXPERIENCE                                   = 0x2757,
    SMSG_GET_ACCOUNT_CHARACTER_LIST_RESULT                        = 0x2759,
    SMSG_LIVE_REGION_GET_ACCOUNT_CHARACTER_LIST_RESULT            = 0x275A,
    SMSG_CHARACTER_RENAME_RESULT                                  = 0x275B,
    SMSG_MODIFY_COOLDOWN                                          = 0x275C,
    SMSG_UPDATE_COOLDOWN                                          = 0x275D,
    SMSG_UPDATE_CHARGE_CATEGORY_COOLDOWN                          = 0x275E,
    SMSG_PRE_RESSURECT                                            = 0x275F,
    SMSG_PLAY_SOUND                                               = 0x2760,
    SMSG_PLAY_MUSIC                                               = 0x2761,
    SMSG_PLAY_OBJECT_SOUND                                        = 0x2762,
    SMSG_PLAY_SPEAKERBOT_SOUND                                    = 0x2763,
    SMSG_STOP_SPEAKERBOT_SOUND                                    = 0x2764,
    SMSG_LIVE_REGION_CHARACTER_COPY_RESULT                        = 0x2765,
    SMSG_LIVE_REGION_ACCOUNT_RESTORE_RESULT                       = 0x2766,
    SMSG_LIVE_REGION_KEY_BINDINGS_COPY_RESULT                     = 0x2767,
    SMSG_SHOW_TRADE_SKILL_RESPONSE                                = 0x2768,
    SMSG_BATTLE_PAY_GET_PRODUCT_LIST_RESPONSE                     = 0x2769,
    SMSG_BATTLE_PAY_GET_PURCHASE_LIST_RESPONSE                    = 0x276A,
    SMSG_BATTLE_PAY_GET_DISTRIBUTION_LIST_RESPONSE                = 0x276B,
    SMSG_BATTLE_PAY_DISTRIBUTION_UNREVOKED                        = 0x276C,
    SMSG_BATTLE_PAY_DISTRIBUTION_UPDATE                           = 0x276D,
    SMSG_BATTLE_PAY_DELIVERY_STARTED                              = 0x276E,
    SMSG_BATTLE_PAY_DELIVERY_ENDED                                = 0x276F,
    SMSG_BATTLE_PAY_MOUNT_DELIVERED                               = 0x2770,
    SMSG_BATTLE_PAY_BATTLE_PET_DELIVERED                          = 0x2771,
    SMSG_BATTLE_PAY_COLLECTION_ITEM_DELIVERED                     = 0x2772,
    SMSG_INSTANCE_SAVE_CREATED                                    = 0x2774,
    SMSG_ENCOUNTER_START                                          = 0x2775,
    SMSG_ENCOUNTER_END                                            = 0x2776,
    SMSG_BATTLE_PAY_START_PURCHASE_RESPONSE                       = 0x2777,
    SMSG_BATTLE_PAY_START_DISTRIBUTION_ASSIGN_TO_TARGET_RESPONSE  = 0x2778,
    SMSG_BATTLE_PAY_PURCHASE_UPDATE                               = 0x277A,
    SMSG_BATTLE_PAY_CONFIRM_PURCHASE                              = 0x277B,
    SMSG_BATTLE_PAY_ACK_FAILED                                    = 0x277C,
    SMSG_CONQUEST_FORMULA_CONSTANTS                               = 0x277D,
    SMSG_CONTACT_LIST                                             = 0x277E,
    SMSG_FRIEND_STATUS                                            = 0x277F,
    SMSG_CHARACTER_OBJECT_TEST_RESPONSE                           = 0x2780,
    ...
    SMSG_GOSSIP_POI                                               = 0x278D,
    SMSG_OPEN_SHIPMENT_NPC_FROM_GOSSIP                            = 0x278F,
    SMSG_GET_SHIPMENT_INFO_RESPONSE                               = 0x2790,
    SMSG_OPEN_SHIPMENT_NPC_RESULT                                 = 0x2791,
    SMSG_CREATE_SHIPMENT_RESPONSE                                 = 0x2792,
    SMSG_COMPLETE_SHIPMENT_RESPONSE                               = 0x2793,
    SMSG_GET_SHIPMENTS_OF_TYPE_RESPONSE                           = 0x2794,
    SMSG_GET_LANDING_PAGE_SHIPMENTS_RESPONSE                      = 0x2795,
    SMSG_READ_ITEM_RESULT_OK                                      = 0x2796,
    SMSG_OPEN_ITEM_FORGE                                          = 0x2797,
    SMSG_CLOSE_ITEM_FORGE                                         = 0x2798,
    SMSG_OPEN_ARTIFACT_FORGE                                      = 0x2799,
    SMSG_CLOSE_ARTIFACT_FORGE                                     = 0x279A,
    SMSG_ARTIFACT_FORGE_ERROR                                     = 0x279B,
    SMSG_ARTIFACT_RESPEC_PROMPT                                   = 0x279C,
    SMSG_ARTIFACT_ENDGAME_POWERS_REFUNDED                         = 0x279D,
    ...
    SMSG_GOSSIP_NPC_INTERACTION                                   = 0x2882,
    SMSG_PERFORM_PLAYER_INTERACTION                               = 0x2883,
    ...
    SMSG_MOVE_UPDATE_APPLY_IMPULSE                                = 0x2E32,
    SMSG_MOVE_UPDATE_REMOVE_IMPULSE                               = 0x2E33,
    SMSG_MOVE_UNK_2E34                                            = 0x2E34,
    SMSG_MOVE_UNK_2E35                                            = 0x2E35,
