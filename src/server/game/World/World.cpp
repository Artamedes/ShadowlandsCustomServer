...
void World::LoadConfigSettings(bool reload)
{
    ...
    {
        TC_LOG_ERROR("server.loading", "StartAlliedRacePlayerLevel (%i) must be in range 1..MaxPlayerLevel(%u). Set to 1.",
    ...
    m_int_configs[CONFIG_CHALLENGE_LEVEL_LIMIT] = sConfigMgr->GetIntDefault("Challenge.LevelLimit", 50);
...
void World::SetInitialWorldSettings()
{
    ...
    TC_LOG_INFO("server.loading", "Loading custom instance zone...");
    ...
    m_timers[WUPDATE_WHO_LIST].SetInterval(2 * IN_MILLISECONDS); // update who list cache every 2 seconds
