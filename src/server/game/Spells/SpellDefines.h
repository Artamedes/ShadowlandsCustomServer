...
enum TriggerCastFlags : uint32
{
    ...
    TRIGGERED_DONT_CREATE_COOLDOWN                  = 0x00004000,
    // reuse                                        = 0x00008000,
    ...
    TRIGGERED_FULL_MASK_NO_CD                       = TRIGGERED_FULL_MASK | TRIGGERED_DONT_CREATE_COOLDOWN | TRIGGERED_IGNORE_SPELL_AND_CATEGORY_CD,
...
struct TC_GAME_API CastSpellExtraArgs
{
    ...
    CastSpellExtraArgs& AddSpellBP3(int32 val) { return AddSpellMod(SPELLVALUE_BASE_POINT3, val); } // because i don't want to type SPELLVALUE_BASE_POINT0 300 times
    ...
    Optional<uint32> SpecialDuration;
    struct
    {
