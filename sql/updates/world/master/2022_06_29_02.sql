...
DELETE FROM disables WHERE sourcetype = 0 AND entry IN (207400, 207401, 366779, 366794);

DELETE FROM spell_script_names WHERE spell_id = 207401;
INSERT INTO spell_script_names (spell_id, scriptname) VALUE (207401, 'spell_ancestral_vigor');
